 ...
 */class st extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let n=r._$litPart$;if(void 0===n){const t=i?.renderBefore??null;r._$litPart$=n=new X(e.insertBefore(L(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return B}}st._$litElement$=!0,st.finalized=!0,nt.litElementHydrateSupport?.({LitElement:st});const at=nt.litElementPolyfillSupport;at?.({LitElement:st}),(nt.litElementVersions??=[]).push("4.2.1");const ot=(t,e,i={},r)=>{const n=new CustomEvent(e,{detail:i,bubbles:r?.bubbles??!0,cancelable:r?.cancelable??!1,composed:r?.composed??!0});return t?.dispatchEvent(n),n},lt=["t_frosty_max","t_cold_max","t_chilly_max","t_cool_max","t_mild_max","t_warm_min","t_hot_min","t_boiling_min","t_perf_min","t_perf_max"];let mt=!1,ct=!1;class _t extends st{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0,this._ro=null,this._hass=void 0}static styles=s`
  ...
  `;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const t=this.renderRoot?.querySelector(".ratio")||this;if(!t)return;this._ro=new ResizeObserver(e=>{for(const i of e){const e=(i.contentBoxSize?.[0]?.inlineSize??i.contentRect?.width??t.clientWidth??300)/300;this.style.setProperty("--sac-scale",String(e))}}),this._ro.observe(t)})}disconnectedCallback(){try{this._ro?.disconnect()}catch(t){}this._ro=null,super.disconnectedCallback()}setConfig(t){const e=t=>{if(!t)return{};if(Array.isArray(t)){const e={};for(const i of t)i&&"object"==typeof i&&Object.assign(e,i);return e}return"object"==typeof t?t:{}},i=e(t?.temperature_anchors),r=e(t?.humidity_alert_anchors),n=e(t?.card_options);t={...t,...i,...r,...n};const s=String(t?.temp_display_unit??"auto").toLowerCase(),a="c"===s||"°c"===s?"c":"f"===s||"°f"===s?"f":"auto",o=String(t?.wind_display_unit??"ms").toLowerCase(),l=/km\/?h/.test(o)?"kmh":o.includes("mph")?"mph":o.includes("kn")?"kn":"ms",m=t=>null==t||""===t?NaN:Number(t),c=((t,e)=>{if(!Number.isFinite(t))return 0;switch(e){case"kmh":return t/3.6;case"mph":return.44704*t;case"kn":return.514444*t;default:return t}})(Number.isFinite(m(t?.default_wind_speed))?m(t.default_wind_speed):0,l);if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');if(!mt){const e=lt.filter(e=>e in t);e.length&&(console.warn("simple-air-comfort-card: Detected legacy/derived or alias keys in YAML. The card now derives hidden neighbors automatically from 10 anchors.\nOmit these keys from YAML:",e,"\nKeep only: t_frosty_min, t_cold_min, t_chilly_min, t_cool_min, t_mild_min, t_perfect_min, t_perfect_max, t_warm_max, t_hot_max, t_boiling_max."),mt=!0)}if(!ct){("t_perfect_min"in t||"t_perfect_max"in t)&&("t_perf_min"in t||"t_perf_max"in t)&&(console.warn("simple-air-comfort-card: Both alias sets present for PERFECT band. Using t_perfect_min/t_perfect_max and ignoring t_perf_min/t_perf_max."),ct=!0)}const _=t=>null==t||""===t?NaN:Number(t),h=Number.isFinite(_(t.ring_pct))?_(t.ring_pct):45,d=Number.isFinite(_(t.inner_pct))?_(t.inner_pct):46.5,p=Number.isFinite(_(t.y_offset_pct))?_(t.y_offset_pct):0,u=this.#t(t),f=this.#e(u);this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,feels_like:t.feels_like??"bom",decimals:Number.isFinite(_(t.decimals))?_(t.decimals):1,temp_display_unit:a,wind_display_unit:l,default_wind_speed:Number.isFinite(c)?c:0,t_frosty_min:f.t_frosty_min,t_frosty_max:f.t_frosty_max,t_cold_min:f.t_cold_min,t_cold_max:f.t_cold_max,t_chilly_min:f.t_chilly_min,t_chilly_max:f.t_chilly_max,t_cool_min:f.t_cool_min,t_cool_max:f.t_cool_max,t_mild_min:f.t_mild_min,t_mild_max:f.t_mild_max,t_perf_min:f.t_perf_min,t_perf_max:f.t_perf_max,t_warm_min:f.t_warm_min,t_warm_max:f.t_warm_max,t_hot_min:f.t_hot_min,t_hot_max:f.t_hot_max,t_boiling_min:f.t_boiling_min,t_boiling_max:f.t_boiling_max,ring_pct:h,inner_pct:d,center_pct:50,y_offset_pct:p,rh_left_inner_pct:Number.isFinite(_(t.rh_left_inner_pct))?_(t.rh_left_inner_pct):40,rh_right_inner_pct:Number.isFinite(_(t.rh_right_inner_pct))?_(t.rh_right_inner_pct):60}}render(){if(!this.hass||!this._config)return W``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e){this.style.setProperty("--sac-temp-bg","#2a2a2a");const{y_center:t}=this.#i();return W`
      ...
      `}const r=(t.attributes.unit_of_measurement||"°C").trim(),n=this.#o(Number.isFinite(+t.state)?+t.state:NaN,r),s=this.#l(Number.isFinite(+e.state)?+e.state:NaN),a=this.#m(i,this._config.default_wind_speed),o=s/100*this.#c(n),l=this.#_(o);let m,c;switch(String(this._config.feels_like||"bom")){case"wind_chill":m=this.#h(n,a),c="Wind Chill";break;case"heat_index":m=this.#d(n,s),c="Heat Index";break;case"humidex":m=this.#p(n,o),c="Humidex";break;default:m=this.#u(n,o,a),c="BoM AT"}const _=this.#f(l),h=this.#g(n),d=this.#b(s),p=this.#x(n),u=this.#n(_),f=this.#a(),g=this.#s(s,n,f),b=Number(this._config?.rh_left_inner_pct??40),x=Number(this._config?.rh_right_inner_pct??60),y=this.#y(),w=Number.isFinite(n)&&n>f.PERFECT.max,v=Number.isFinite(n)&&n<f.PERFECT.min,$=Number.isFinite(s)&&s<b,C=Number.isFinite(s)&&s>x,A=t=>`\n      color:white;\n      text-shadow:\n        0 0 calc(var(--sac-scale,1) * 2px)  rgba(255,255,255,.95),\n        0 0 calc(var(--sac-scale,1) * 10px) ${t},\n        0 0 calc(var(--sac-scale,1) * 22px) ${t},\n        0 0 calc(var(--sac-scale,1) * 40px) ${t},\n        0 0 calc(var(--sac-scale,1) * 70px) ${t},\n        0 0 calc(var(--sac-scale,1) * 100px) ${t};\n    `,T=w?A(y.hot):"",N=v?A(y.cold):"",E=$?A(y.humid):"",O=C?A(y.humid):"",L=this.#w(n),F=Number.isFinite(L)?this.#v(L+(this._config.y_offset_pct||0),0,100):50,R=this.#$(s),M=Number.isFinite(R)?this.#v(R,0,100):50,k=!Number.isFinite(s)||!Number.isFinite(n)||(s<b||s>x||n<f.PERFECT.min||n>f.PERFECT.max),S=this._config.decimals,P=this._config?.temp_display_unit||"auto",H="c"===P?"°C":"f"===P?"°F":r,D=this.#C(this.#A(l,H),S)+` ${H}`,I=this.#C(this.#A(m,H),S)+` ${H}`,U=this.#C(this.#A(n,H),S)+` ${H}`,B=Number.isFinite(s)?this.#T(s,S).toFixed(S)+" %":"—";return this.style.setProperty("--sac-temp-bg",p),W`
      <div class="ratio" role="img" aria-label="Air comfort dial">
        <div class="canvas">
          ${this.#r({Tc:n,RH:s,dpC:l,atC:m,dewText:_,tempText:h,rhText:d,ringGrad:u,innerGrad:g,xPct:M,yPct:F,outside:k,outUnit:H,d:S,dewOut:D,atOut:I,tempRaw:U,rhRaw:B,atTag:c,axisTopStyle:T,axisBottomStyle:N,axisLeftStyle:E,axisRightStyle:O})}
        </div>
      </div>
    `}#r({dewText:t,tempText:e,rhText:i,ringGrad:r,innerGrad:n,xPct:s,yPct:a,outside:o,dewOut:l,atOut:m,tempRaw:c,rhRaw:_,atTag:h,axisTopStyle:d="",axisBottomStyle:p="",axisLeftStyle:u="",axisRightStyle:f=""}){return W`
      <div class="header">
  ...
  `;connectedCallback(){super.connectedCallback(),window.loadCardHelpers?.().catch(()=>{})}set hass(t){this._hass=t,this._autoFillDefaults(),this.requestUpdate()}get hass(){return this._hass}setConfig(t){const e=t=>{if(!t)return{};if(Array.isArray(t)){const e={};for(const i of t)i&&"object"==typeof i&&Object.assign(e,i);return e}return"object"==typeof t?t:{}},i={...t??{},...e(t?.temperature_anchors),...e(t?.humidity_alert_anchors),...e(t?.card_options)};this._config={name:"Area Name",temperature:void 0,humidity:void 0,windspeed:void 0,temp_display_unit:"auto",wind_display_unit:"ms",feels_like:"bom",decimals:1,default_wind_speed:.1,t_frosty_min:0,t_frosty_max:2.9,t_cold_min:3,t_cold_max:4.9,t_chilly_min:5,t_chilly_max:8.9,t_cool_min:9,t_cool_max:13.9,t_mild_min:14,t_mild_max:18.9,t_perfect_min:19,t_perfect_max:23.9,t_warm_min:24,t_warm_max:27.9,t_hot_min:28,t_hot_max:34.9,t_boiling_min:35,t_boiling_max:50,y_offset_pct:0,rh_left_inner_pct:40,rh_right_inner_pct:60,...i},this._defaults={hot_max:34.9,warm_max:27.9,perf_max:23.9,perf_min:19,perfect_max:23.9,perfect_min:19,mild_min:14,cool_min:9,chilly_min:5,cold_min:3}}render(){return this.hass&&this._config?W`
    ...
    `:W``}_label=t=>{const e=t.name;return{name:"Name",temperature:"Temperature entity",humidity:"Humidity entity",windspeed:"Wind speed entity (optional)",feels_like:"Feels-like formula",default_wind_speed:`Default wind speed (${{ms:"m/s",kmh:"km/h",mph:"mph",kn:"kn"}[this._config?.wind_display_unit||"ms"]})`,decimals:"Decimals",rh_left_inner_pct:"Inner circle left RH (%)",rh_right_inner_pct:"Inner circle right RH (%)",y_offset_pct:"Vertical dot offset (%)"}[e]??e};_bandBaseColour(t){const e=String(t||"").toLowerCase();return"frosty"===e?"mediumblue":"cold"===e?"dodgerblue":"chilly"===e?"deepskyblue":"cool"===e?"mediumaquamarine":"mild"===e?"seagreen":"perfect"===e?"limegreen":"warm"===e?"gold":"hot"===e?"orange":"boiling"===e?"crimson":"dimgray"}_bandForAnchor(t){switch(t){case"t_boiling_max":return"boiling";case"t_hot_max":return"hot";case"t_warm_max":return"warm";case"t_perfect_max":case"t_perfect_min":return"perfect";case"t_mild_min":return"mild";case"t_cool_min":return"cool";case"t_chilly_min":return"chilly";case"t_cold_min":return"cold";case"t_frosty_min":return"frosty";default:return null}}_anchorRow(t,e,i,r){const n=Number(this._config?.[t]),s=Number.isFinite(n)?`${n.toFixed(1)} °C`:"—",a=this._bandForAnchor(t),o=a?this._bandBaseColour(a):null,l=r?this._capFor(t):null,m=!!l&&n<=l.lo,c=!!l&&n>=l.hi;return W`
      <div class="row">
    ...
    `}_rhRow(t,e){const i=Number(this._config?.[t]),r=Number.isFinite(i)?`${i.toFixed(1)} %`:"—",n=.1,s=Number(this._config?.rh_left_inner_pct??40),a=Number(this._config?.rh_right_inner_pct??60);let o=!1,l=!1;"rh_left_inner_pct"===t?(o=i<=0,l=i>=a-n):(o=i<=s+n,l=i>=100);const m=this._helper({name:t});return W`
      <div class="row">
        <div class="name">${e}</div>

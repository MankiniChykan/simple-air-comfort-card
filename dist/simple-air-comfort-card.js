 ...
 */class nt extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let s=r._$litPart$;if(void 0===s){const t=i?.renderBefore??null;r._$litPart$=s=new X(e.insertBefore(R(),t),t,void 0,i??{})}return s._$AI(t),s})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}nt._$litElement$=!0,nt.finalized=!0,st.litElementHydrateSupport?.({LitElement:nt});const at=st.litElementPolyfillSupport;at?.({LitElement:nt}),(st.litElementVersions??=[]).push("4.2.1");const ot=(t,e,i,r)=>{const s=new Event(e,{bubbles:r?.bubbles??!0,cancelable:r?.cancelable??!1,composed:r?.composed??!0});return s.detail=i,t.dispatchEvent(s),s};class lt extends nt{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0,this._ro=null,this._hass=void 0}static styles=n`
  ...
  `;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const t=this.renderRoot?.querySelector(".ratio")||this;if(!t)return;this._ro=new ResizeObserver(e=>{for(const i of e){const e=(i.contentBoxSize?.[0]?.inlineSize??i.contentRect?.width??t.clientWidth??300)/300;this.style.setProperty("--sac-scale",String(e))}}),this._ro.observe(t)})}disconnectedCallback(){try{this._ro?.disconnect()}catch(t){}this._ro=null,super.disconnectedCallback()}setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');const e=t=>null==t||""===t?NaN:Number(t),i=Number.isFinite(e(t.ring_pct))?e(t.ring_pct):45,r=Number.isFinite(e(t.inner_pct))?e(t.inner_pct):46.5,s=Number.isFinite(e(t.y_offset_pct))?e(t.y_offset_pct):0;this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,feels_like:t.feels_like??"bom",decimals:Number.isFinite(e(t.decimals))?e(t.decimals):1,default_wind_speed:Number.isFinite(e(t.default_wind_speed))?e(t.default_wind_speed):0,t_frosty_min:Number.isFinite(e(t.t_frosty_min))?e(t.t_frosty_min):0,t_frosty_max:Number.isFinite(e(t.t_frosty_max))?e(t.t_frosty_max):2.9,t_cold_min:Number.isFinite(e(t.t_cold_min))?e(t.t_cold_min):3,t_cold_max:Number.isFinite(e(t.t_cold_max))?e(t.t_cold_max):4.9,t_chilly_min:Number.isFinite(e(t.t_chilly_min))?e(t.t_chilly_min):5,t_chilly_max:Number.isFinite(e(t.t_chilly_max))?e(t.t_chilly_max):8.9,t_cool_min:Number.isFinite(e(t.t_cool_min))?e(t.t_cool_min):9,t_cool_max:Number.isFinite(e(t.t_cool_max))?e(t.t_cool_max):13.9,t_mild_min:Number.isFinite(e(t.t_mild_min))?e(t.t_mild_min):14,t_mild_max:Number.isFinite(e(t.t_mild_max))?e(t.t_mild_max):18.9,t_perf_min:Number.isFinite(e(t.t_perf_min))?e(t.t_perf_min):19,t_perf_max:Number.isFinite(e(t.t_perf_max))?e(t.t_perf_max):23.9,t_warm_min:Number.isFinite(e(t.t_warm_min))?e(t.t_warm_min):24,t_warm_max:Number.isFinite(e(t.t_warm_max))?e(t.t_warm_max):27.9,t_hot_min:Number.isFinite(e(t.t_hot_min))?e(t.t_hot_min):28,t_hot_max:Number.isFinite(e(t.t_hot_max))?e(t.t_hot_max):34.9,t_boiling_min:Number.isFinite(e(t.t_boiling_min))?e(t.t_boiling_min):35,t_boiling_max:Number.isFinite(e(t.t_boiling_max))?e(t.t_boiling_max):50,ring_pct:i,inner_pct:r,center_pct:50,y_offset_pct:s,rh_left_inner_pct:Number.isFinite(e(t.rh_left_inner_pct))?e(t.rh_left_inner_pct):40,rh_right_inner_pct:Number.isFinite(e(t.rh_right_inner_pct))?e(t.rh_right_inner_pct):60}}render(){if(!this.hass||!this._config)return U``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e){this.style.setProperty("--sac-temp-bg","#2a2a2a");const{y_center:t}=this.#t();return U`
      ...
      `}const r=(t.attributes.unit_of_measurement||"°C").trim(),s=this.#n(Number.isFinite(+t.state)?+t.state:NaN,r),n=this.#a(Number.isFinite(+e.state)?+e.state:NaN),a=this.#o(i,this._config.default_wind_speed),o=n/100*this.#l(s),l=this.#c(o);let c,m;switch(String(this._config.feels_like||"bom")){case"wind_chill":c=this.#m(s,a),m="Wind Chill";break;case"heat_index":c=this.#h(s,n),m="Heat Index";break;case"humidex":c=this.#d(s,o),m="Humidex";break;default:c=this.#_(s,o,a),m="BoM AT"}const h=this.#p(l),d=this.#u(s),_=this.#f(n),p=this.#g(s),u=this.#i(h),f=this.#s(),g=this.#r(n,s,f),b=Number(this._config?.rh_left_inner_pct??40),x=Number(this._config?.rh_right_inner_pct??60),y=this.#b(),v=Number.isFinite(s)&&s>f.PERFECT.max,w=Number.isFinite(s)&&s<f.PERFECT.min,$=Number.isFinite(n)&&n<b,C=Number.isFinite(n)&&n>x,A=t=>`\n      color:white;\n      text-shadow:\n        0 0 calc(var(--sac-scale,1) * 2px)  rgba(255,255,255,.95),\n        0 0 calc(var(--sac-scale,1) * 10px) ${t},\n        0 0 calc(var(--sac-scale,1) * 22px) ${t},\n        0 0 calc(var(--sac-scale,1) * 40px) ${t},\n        0 0 calc(var(--sac-scale,1) * 70px) ${t},\n        0 0 calc(var(--sac-scale,1) * 100px) ${t};\n    `,T=v?A(y.hot):"",N=w?A(y.cold):"",E=$?A(y.humid):"",F=C?A(y.humid):"",R=this.#x(s),O=Number.isFinite(R)?this.#y(R+(this._config.y_offset_pct||0),0,100):50,L=this.#v(n),S=Number.isFinite(L)?this.#y(L,0,100):50,M=!Number.isFinite(n)||!Number.isFinite(s)||(n<b||n>x||s<f.PERFECT.min||s>f.PERFECT.max),k=this._config.decimals,P=r,H=this.#w(this.#$(l,P),k)+` ${P}`,I=this.#w(this.#$(c,P),k)+` ${P}`,D=this.#w(this.#$(s,P),k)+` ${P}`,B=Number.isFinite(n)?this.#C(n,k).toFixed(k)+" %":"—";return this.style.setProperty("--sac-temp-bg",p),U`
      <div class="ratio" role="img" aria-label="Air comfort dial">
        <div class="canvas">
          ${this.#e({Tc:s,RH:n,dpC:l,atC:c,dewText:h,tempText:d,rhText:_,ringGrad:u,innerGrad:g,xPct:S,yPct:O,outside:M,outUnit:P,d:k,dewOut:H,atOut:I,tempRaw:D,rhRaw:B,atTag:m,axisTopStyle:T,axisBottomStyle:N,axisLeftStyle:E,axisRightStyle:F})}
        </div>
      </div>
  ...
  `;connectedCallback(){super.connectedCallback(),window.loadCardHelpers?.().catch(()=>{})}set hass(t){this._hass=t,this._autoFillDefaults(),this.requestUpdate()}get hass(){return this._hass}setConfig(t){this._config={name:"Area Name",temperature:void 0,humidity:void 0,windspeed:void 0,feels_like:"bom",decimals:1,default_wind_speed:.1,t_frosty_min:0,t_frosty_max:2.9,t_cold_min:3,t_cold_max:4.9,t_chilly_min:5,t_chilly_max:8.9,t_cool_min:9,t_cool_max:13.9,t_mild_min:14,t_mild_max:18.9,t_perf_min:19,t_perf_max:23.9,t_warm_min:24,t_warm_max:27.9,t_hot_min:28,t_hot_max:34.9,t_boiling_min:35,t_boiling_max:50,y_offset_pct:0,rh_left_inner_pct:40,rh_right_inner_pct:60,...t??{}},this._defaults={hot_max:34.9,warm_max:27.9,perf_max:23.9,perf_min:19,mild_min:14,cool_min:9,chilly_min:5,cold_min:3}}render(){return this.hass&&this._config?U`<div class="wrap">
      ...
      ${this._anchorRow("t_perf_max","PERFECT.max → Inner Comfort Circle Top","High Temperature Alert : Limit ±4°C from default.",!0)}

      <!-- Center row (green, aligned like others) -->
      ${(()=>{const t=this._centerTemp(),e=Number(this._config?.t_perf_min),i=Number(this._config?.t_perf_max),r=Number.isFinite(e)&&Number.isFinite(i)?`Read-only. Midpoint of PERFECT band: (${e.toFixed(1)} + ${i.toFixed(1)}) ÷ 2 = ${((e+i)/2).toFixed(2)} °C. Updates automatically when either edge changes.`:"Read-only. Midpoint of PERFECT band. Set PERFECT.min and PERFECT.max to compute.";return U`
          <div class="row">
      ...
      ${this._anchorRow("t_perf_min","PERFECT.min → Inner Comfort Circle Bottom","Low Temperature Alert Limit : ±4°C from default.",!0)}
    ...
    `}_rhRow(t,e){const i=Number(this._config?.[t]),r=Number.isFinite(i)?`${i.toFixed(1)} %`:"—",s=.1,n=Number(this._config?.rh_left_inner_pct??40),a=Number(this._config?.rh_right_inner_pct??60);let o=!1,l=!1;"rh_left_inner_pct"===t?(o=i<=0,l=i>=a-s):(o=i<=n+s,l=i>=100);const c=this._helper({name:t});return U`
      <div class="row">
        <div class="name">${e}</div>

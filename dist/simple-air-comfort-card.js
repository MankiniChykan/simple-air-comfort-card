 ...
 */class st extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let n=r._$litPart$;if(void 0===n){const t=i?.renderBefore??null;r._$litPart$=n=new X(e.insertBefore(F(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return U}}st._$litElement$=!0,st.finalized=!0,nt.litElementHydrateSupport?.({LitElement:st});const at=nt.litElementPolyfillSupport;at?.({LitElement:st}),(nt.litElementVersions??=[]).push("4.2.1");const ot=(t,e,i={},r)=>{const n=new CustomEvent(e,{detail:i,bubbles:r?.bubbles??!0,cancelable:r?.cancelable??!1,composed:r?.composed??!0});return t?.dispatchEvent(n),n},mt=["t_frosty_max","t_cold_max","t_chilly_max","t_cool_max","t_mild_max","t_warm_min","t_hot_min","t_boiling_min","t_perf_min","t_perf_max"];let lt=!1,_t=!1;const ct={indoor:{t_frosty_min:0,t_cold_min:3,t_chilly_min:5,t_cool_min:9,t_mild_min:14,t_perfect_min:19,t_perfect_max:23.9,t_warm_max:27.9,t_hot_max:34.9,t_boiling_max:50},outdoor:{t_frosty_min:-5,t_cold_min:0,t_chilly_min:3,t_cool_min:8,t_mild_min:12,t_perfect_min:17,t_perfect_max:26,t_warm_max:30,t_hot_max:36,t_boiling_max:45}},ht=t=>"outdoor"===String(t||"").toLowerCase()?"outdoor":"indoor";class dt extends st{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0,this._ro=null,this._hass=void 0}static styles=s`
  ...
  `;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const t=this.renderRoot?.querySelector(".ratio")||this;if(!t)return;this._ro=new ResizeObserver(e=>{for(const i of e){const e=(i.contentBoxSize?.[0]?.inlineSize??i.contentRect?.width??t.clientWidth??300)/300;this.style.setProperty("--sac-scale",String(e))}}),this._ro.observe(t)})}disconnectedCallback(){try{this._ro?.disconnect()}catch(t){}this._ro=null,super.disconnectedCallback()}setConfig(t){const e=t=>{if(!t)return{};if(Array.isArray(t)){const e={};for(const i of t)i&&"object"==typeof i&&Object.assign(e,i);return e}return"object"==typeof t?t:{}},i=e(t?.temperature_anchors),r=e(t?.humidity_alert_anchors),n=e(t?.card_options);t={...t,...i,...r,...n};const s=ht(t?.temp_preset),a=String(t?.temp_display_unit??"auto").toLowerCase(),o="c"===a||"°c"===a?"c":"f"===a||"°f"===a?"f":"auto",m=String(t?.wind_display_unit??"ms").toLowerCase(),l=/km\/?h/.test(m)?"kmh":m.includes("mph")?"mph":m.includes("kn")?"kn":"ms",_=t=>null==t||""===t?NaN:Number(t),c=((t,e)=>{if(!Number.isFinite(t))return 0;switch(e){case"kmh":return t/3.6;case"mph":return.44704*t;case"kn":return.514444*t;default:return t}})(Number.isFinite(_(t?.default_wind_speed))?_(t.default_wind_speed):0,l);if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');if(!lt){const e=mt.filter(e=>e in t);e.length&&(console.warn("simple-air-comfort-card: Detected legacy/derived or alias keys in YAML. The card now derives hidden neighbors automatically from 10 anchors.\nOmit these keys from YAML:",e,"\nKeep only: t_frosty_min, t_cold_min, t_chilly_min, t_cool_min, t_mild_min, t_perfect_min, t_perfect_max, t_warm_max, t_hot_max, t_boiling_max."),lt=!0)}if(!_t){("t_perfect_min"in t||"t_perfect_max"in t)&&("t_perf_min"in t||"t_perf_max"in t)&&(console.warn("simple-air-comfort-card: Both alias sets present for PERFECT band. Using t_perfect_min/t_perfect_max and ignoring t_perf_min/t_perf_max."),_t=!0)}const h=t=>null==t||""===t?NaN:Number(t),d=Number.isFinite(h(t.ring_pct))?h(t.ring_pct):45,p=Number.isFinite(h(t.inner_pct))?h(t.inner_pct):46.5,u=Number.isFinite(h(t.y_offset_pct))?h(t.y_offset_pct):0,f=this.#t(t,s),g=this.#e(f);this._config={temp_preset:s,name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,feels_like:t.feels_like??"bom",decimals:Number.isFinite(h(t.decimals))?h(t.decimals):1,temp_display_unit:o,wind_display_unit:l,default_wind_speed:Number.isFinite(c)?c:0,cap_degrees:Number.isFinite(h(t.cap_degrees))?h(t.cap_degrees):6,t_frosty_min:g.t_frosty_min,t_frosty_max:g.t_frosty_max,t_cold_min:g.t_cold_min,t_cold_max:g.t_cold_max,t_chilly_min:g.t_chilly_min,t_chilly_max:g.t_chilly_max,t_cool_min:g.t_cool_min,t_cool_max:g.t_cool_max,t_mild_min:g.t_mild_min,t_mild_max:g.t_mild_max,t_perf_min:g.t_perf_min,t_perf_max:g.t_perf_max,t_warm_min:g.t_warm_min,t_warm_max:g.t_warm_max,t_hot_min:g.t_hot_min,t_hot_max:g.t_hot_max,t_boiling_min:g.t_boiling_min,t_boiling_max:g.t_boiling_max,ring_pct:d,inner_pct:p,center_pct:50,y_offset_pct:u,rh_left_inner_pct:Number.isFinite(h(t.rh_left_inner_pct))?h(t.rh_left_inner_pct):40,rh_right_inner_pct:Number.isFinite(h(t.rh_right_inner_pct))?h(t.rh_right_inner_pct):60}}render(){if(!this.hass||!this._config)return B``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e){this.style.setProperty("--sac-temp-bg","#2a2a2a");const{y_center:t}=this.#i();return B`
      ...
      `}const r=(t.attributes.unit_of_measurement||"°C").trim(),n=this.#o(Number.isFinite(+t.state)?+t.state:NaN,r),s=this.#m(Number.isFinite(+e.state)?+e.state:NaN),a=this.#l(i,this._config.default_wind_speed),o=s/100*this.#_(n),m=this.#c(o);let l,_;switch(String(this._config.feels_like||"bom")){case"wind_chill":l=this.#h(n,a),_="Wind Chill";break;case"heat_index":l=this.#d(n,s),_="Heat Index";break;case"humidex":l=this.#p(n,o),_="Humidex";break;default:l=this.#u(n,o,a),_="BoM AT"}const c=this.#f(m),h=this.#g(n),d=this.#x(s),p=this.#b(n),u=this.#n(c),f=this.#a(),g=this.#s(s,n,f),x=Number(this._config?.rh_left_inner_pct??40),b=Number(this._config?.rh_right_inner_pct??60),y=this.#y(),w=Number.isFinite(n)&&n>f.PERFECT.max,$=Number.isFinite(n)&&n<f.PERFECT.min,v=Number.isFinite(s)&&s<x,C=Number.isFinite(s)&&s>b,A=t=>`\n      color:white;\n      text-shadow:\n        0 0 calc(var(--sac-scale,1) * 2px)  rgba(255,255,255,.95),\n        0 0 calc(var(--sac-scale,1) * 10px) ${t},\n        0 0 calc(var(--sac-scale,1) * 22px) ${t},\n        0 0 calc(var(--sac-scale,1) * 40px) ${t},\n        0 0 calc(var(--sac-scale,1) * 70px) ${t},\n        0 0 calc(var(--sac-scale,1) * 100px) ${t};\n    `,T=w?A(y.hot):"",N=$?A(y.cold):"",E=v?A(y.humid):"",O=C?A(y.humid):"",F=this.#w(n),R=Number.isFinite(F)?this.#$(F+(this._config.y_offset_pct||0),0,100):50,M=this.#v(s),L=Number.isFinite(M)?this.#$(M,0,100):50,k=!Number.isFinite(s)||!Number.isFinite(n)||(s<x||s>b||n<f.PERFECT.min||n>f.PERFECT.max),S=this._config.decimals,H=this._config?.temp_display_unit||"auto",P="c"===H?"°C":"f"===H?"°F":r,D=this.#C(this.#A(m,P),S)+` ${P}`,I=this.#C(this.#A(l,P),S)+` ${P}`,W=this.#C(this.#A(n,P),S)+` ${P}`,U=Number.isFinite(s)?this.#T(s,S).toFixed(S)+" %":"—";return this.style.setProperty("--sac-temp-bg",p),B`
      <div class="ratio" role="img" aria-label="Air comfort dial">
        <div class="canvas">
          ${this.#r({Tc:n,RH:s,dpC:m,atC:l,dewText:c,tempText:h,rhText:d,ringGrad:u,innerGrad:g,xPct:L,yPct:R,outside:k,outUnit:P,d:S,dewOut:D,atOut:I,tempRaw:W,rhRaw:U,atTag:_,axisTopStyle:T,axisBottomStyle:N,axisLeftStyle:E,axisRightStyle:O})}
        </div>
      </div>
    `}#r({dewText:t,tempText:e,rhText:i,ringGrad:r,innerGrad:n,xPct:s,yPct:a,outside:o,dewOut:m,atOut:l,tempRaw:_,rhRaw:c,atTag:h,axisTopStyle:d="",axisBottomStyle:p="",axisLeftStyle:u="",axisRightStyle:f=""}){return B`
      <div class="header">
  ...
  `;connectedCallback(){super.connectedCallback(),window.loadCardHelpers?.().catch(()=>{})}_capDegrees(){const t=Number(this._config?.cap_degrees);return Number.isFinite(t)?Math.max(0,Math.min(20,t)):6}set hass(t){this._hass=t,this._autoFillDefaults(),this.requestUpdate()}get hass(){return this._hass}setConfig(t){const e=t=>{if(!t)return{};if(Array.isArray(t)){const e={};for(const i of t)i&&"object"==typeof i&&Object.assign(e,i);return e}return"object"==typeof t?t:{}},i={...t??{},...e(t?.temperature_anchors),...e(t?.humidity_alert_anchors),...e(t?.card_options)},r=ht(i?.temp_preset),n=ct[r];this._config={name:"Area Name",temperature:void 0,humidity:void 0,windspeed:void 0,temp_display_unit:"auto",wind_display_unit:"ms",feels_like:"bom",decimals:1,default_wind_speed:.1,cap_degrees:6,temp_preset:r,t_frosty_min:n.t_frosty_min,t_cold_min:n.t_cold_min,t_chilly_min:n.t_chilly_min,t_cool_min:n.t_cool_min,t_mild_min:n.t_mild_min,t_perfect_min:n.t_perfect_min,t_perfect_max:n.t_perfect_max,t_warm_max:n.t_warm_max,t_hot_max:n.t_hot_max,t_boiling_max:n.t_boiling_max,y_offset_pct:0,rh_left_inner_pct:40,rh_right_inner_pct:60,...i},this._defaults={hot_max:n.t_hot_max,warm_max:n.t_warm_max,perf_max:n.t_perfect_max,perf_min:n.t_perfect_min,perfect_max:n.t_perfect_max,perfect_min:n.t_perfect_min,mild_min:n.t_mild_min,cool_min:n.t_cool_min,chilly_min:n.t_chilly_min,cold_min:n.t_cold_min},this._config=this._applyTempsRowBiDirectional(this._config)}render(){if(!this.hass||!this._config)return B``;const t=`${this._capDegrees().toFixed(1)}°C`;return B`
    ...
    `}_rhRow(t,e){const i=Number(this._config?.[t]),r=Number.isFinite(i)?`${i.toFixed(1)} %`:"—",n=.1,s=Number(this._config?.rh_left_inner_pct??40),a=Number(this._config?.rh_right_inner_pct??60);let o=!1,m=!1;"rh_left_inner_pct"===t?(o=i<=0,m=i>=a-n):(o=i<=s+n,m=i>=100);const l=this._helper({name:t});return B`
      <div class="row">
        <div class="name">${e}</div>

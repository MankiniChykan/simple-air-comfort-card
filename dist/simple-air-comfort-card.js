 ...
 */class nt extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new Z(e.insertBefore(T(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return I}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const ot=rt.litElementPolyfillSupport;ot?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.1");const at=(t,e,i,s)=>{const r=new Event(e,{bubbles:s?.bubbles??!0,cancelable:s?.cancelable??!1,composed:s?.composed??!0});return r.detail=i,t.dispatchEvent(r),r};class ht extends nt{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0}static styles=n`
  ...
  `;setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');const e=t=>null==t||""===t?NaN:Number(t),i=Number.isFinite(e(t.temp_min))?e(t.temp_min):15,s=Number.isFinite(e(t.temp_max))?e(t.temp_max):35;if(s<=i)throw new Error("simple-air-comfort-card: temp_max must be > temp_min.");this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,decimals:Number.isFinite(e(t.decimals))?e(t.decimals):1,default_wind_speed:Number.isFinite(e(t.default_wind_speed))?e(t.default_wind_speed):0,temp_min:i,temp_max:s}}render(){if(!this.hass||!this._config)return B``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e)return B`<ha-card>
      ...
      </ha-card>`;const s=(t.attributes.unit_of_measurement||"°C").trim(),r=this.#r(Number.isFinite(+t.state)?+t.state:NaN,s),n=this.#n(Number.isFinite(+e.state)?+e.state:NaN),o=this.#o(i,this._config.default_wind_speed),a=n/100*this.#a(r),h=this.#h(a),d=this.#d(r,a,o),l=this.#l(h),c=this.#c(r),p=this.#p(n),u=this.#e(r),m=this.#i(l),f=this.#s(n,r),{temp_min:g,temp_max:_}=this._config,b=Number.isFinite(r)?this.#u(this.#m(r,g,_,0,100)+15,0,100):50,$=Number.isFinite(n)?this.#u(n+.5,0,100):50,y=!Number.isFinite(n)||!Number.isFinite(r)||(n<40||n>60||r<18||r>26.4),v=this._config.decimals,x=s,w=this.#f(this.#g(h,x),v)+` ${x}`,A=this.#f(this.#g(d,x),v)+` ${x}`,C=this.#f(this.#g(r,x),v)+` ${x}`,N=Number.isFinite(n)?this.#_(n,v).toFixed(v)+" %":"—";return B`<ha-card style="--sac-temp-bg:${u}">
      <div class="ratio">
        <div class="canvas">
          ${this.#t({Tc:r,RH:n,dpC:h,atC:d,dewText:l,tempText:c,rhText:p,cardBg:u,ringGrad:m,innerGrad:f,xPct:$,yPct:b,outside:y,outUnit:x,d:v,dewOut:w,atOut:A,tempRaw:C,rhRaw:N})}
        </div>
      </div>
    </ha-card>`}#t({dewText:t,tempText:e,rhText:i,ringGrad:s,innerGrad:r,xPct:n,yPct:o,outside:a,dewOut:h,atOut:d,tempRaw:l,rhRaw:c}){return B`
      <div class="header">

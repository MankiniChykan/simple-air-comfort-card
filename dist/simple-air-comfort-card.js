 ...
 */class nt extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new Z(e.insertBefore(P(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return I}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const ot=rt.litElementPolyfillSupport;ot?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.1");const at=(t,e,i,s)=>{const r=new Event(e,{bubbles:s?.bubbles??!0,cancelable:s?.cancelable??!1,composed:s?.composed??!0});return r.detail=i,t.dispatchEvent(r),r};class lt extends nt{static properties={hass:{type:Object},_config:{state:!0}};static styles=n`
  ...
  `;setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" entities are required.');this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,decimals:Number.isFinite(t.decimals)?t.decimals:1,default_wind_speed:Number.isFinite(t.default_wind_speed)?t.default_wind_speed:0,temp_min:Number.isFinite(t.temp_min)?t.temp_min:15,temp_max:Number.isFinite(t.temp_max)?t.temp_max:35}}render(){if(!this.hass||!this._config)return B``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e)return B`<ha-card>
      ...
      </ha-card>`;const s=(t.attributes.unit_of_measurement||"°C").trim(),r=this.#t(parseFloat(t.state),s),n=this.#e(parseFloat(e.state)),o=this.#i(i,this._config.default_wind_speed),a=n/100*this.#s(r),l=this.#r(a),h=this.#n(r,a,o),d=this.#o(l),c=this.#a(r),p=this.#l(n),u=this.#h(r),m=this.#d(d),f=this.#c(n,r),{temp_min:g,temp_max:_}=this._config,b=this.#p(r,g,_,0,100),$=this.#u(n+.5,0,100),y=n<40||n>60||r<18||r>26.4,v=this._config.decimals,w=s,A=this.#m(this.#f(l,w),v)+` ${w}`,x=this.#m(this.#f(h,w),v)+` ${w}`;return B`
      <ha-card style="--sac-temp-bg:${u}">
        <div class="canvas">
          ...
          <div class="graphic">
            ...
            <div class="dot ${y?"outside":""}"
                style="left:${$}%; bottom:${b}%;">
            </div>
          </div>
        </div>
      </ha-card>
    `}getCardSize(){return 10}firstUpdated(){this.#g(),this._ro=new ResizeObserver(()=>this.#g()),this._ro.observe(this)}updated(t){super.updated?.(t),this.#g()}disconnectedCallback(){super.disconnectedCallback?.(),this._ro&&this._ro.disconnect()}#g(){try{at(this,"hass-resize"),at(this,"iron-resize")}catch(t){}const t=this.shadowRoot?.querySelector("ha-card");t&&t.style.setProperty("--_sac-reflow",String(performance.now()))}#n(t,e,i){return t+.33*e-.7*i-4}#s(t){return Number.isFinite(t)?t>=0?6.1121*Math.exp(t/(257.14+t)*(18.678-t/234.5)):6.1115*Math.exp(t/(279.82+t)*(23.036-t/333.7)):NaN}#r(t){if(!Number.isFinite(t)||t<=0)return NaN;let e=-80,i=60,s=0;for(let r=0;r<60;r++){s=(e+i)/2;const r=this.#s(s);if(!Number.isFinite(r))break;if(r>t?i=s:e=s,Math.abs(i-e)<1e-4)break}return s}#o(t){return Number.isFinite(t)?t<5?"Very Dry":t>=5&&t<=10?"Dry":t>=10.1&&t<=12.79?"Pleasant":t>=12.8&&t<=15.49?"Comfortable":t>=15.5&&t<=18.39?"Sticky Humid":t>=18.4&&t<=21.19?"Muggy":t>=21.2&&t<=23.9?"Sweltering":"Stifling":"Unknown"}#a(t){return Number.isFinite(t)?t<3?"FROSTY":t>=3.1&&t<=4.99?"COLD":t>=5&&t<=8.99?"CHILLY":t>=9&&t<=13.99?"COOL":t>=14&&t<=18.99?"MILD":t>=19&&t<=23.99?"PERFECT":t>=24&&t<=27.99?"WARM":t>=28&&t<=34.99?"HOT":"BOILING":"N/A"}#l(t){return Number.isFinite(t)?t<40?"DRY":t<=60?"COMFY":"HUMID":"N/A"}#_(t){return Number.isFinite(t)?t<3?"frosty":t<=4.99?"cold":t<=8.99?"chilly":t<=13.99?"cool":t<=18.99?"mild":t<=23.99?"perfect":t<=27.99?"warm":t<=34.99?"hot":"boiling":"n/a"}#b(t){const e=String(t||"").toLowerCase();return"frosty"===e?"mediumblue":"cold"===e?"dodgerblue":"chilly"===e?"deepskyblue":"cool"===e?"mediumaquamarine":"mild"===e?"seagreen":"perfect"===e?"limegreen":"warm"===e?"gold":"hot"===e?"orange":"boiling"===e?"crimson":"dimgray"}#h(t){const e=this.#_(t);return`radial-gradient(circle, rgba(100,100,100,0.15), rgba(100,100,100,0.15), rgba(100,100,100,0.15), ${this.#b(e)})`}#$(t){return`box-shadow:\n      0 0 0 3px white inset,\n      0 0 18px 6px ${{Unknown:"dimgray",Unavailable:"dimgray","Very Dry":"deepskyblue",Dry:"mediumaquamarine",Pleasant:"limegreen",Comfortable:"yellowgreen","Sticky Humid":"yellow",Muggy:"gold",Sweltering:"orange",Stifling:"crimson"}[t]||"rgba(100,100,100,0.15)"},\n      0 0 22px 10px rgba(0,0,0,0.25)`}#d(t){const e=(t=>{switch(t){case"Very Dry":return"deepskyblue";case"Dry":return"mediumaquamarine";case"Pleasant":return"limegreen";case"Comfortable":return"yellowgreen";case"Sticky Humid":return"yellow";case"Muggy":return"gold";case"Sweltering":return"orange";case"Stifling":return"crimson";default:return"dimgray"}})(t||"Unknown");return`radial-gradient(circle, ${e}, 55%, rgba(100,100,100,0.15), rgba(100,100,100,0.15))`}#c(t,e){let i="black";Number.isFinite(t)?(t<40||t>60)&&(i="hotpink"):i="dimgray";let s="dimgray";return Number.isFinite(e)?e>34.9||e>26.5&&e<=34.9?s="rgba(255, 69, 0, 0.8)":e>24&&e<=26.5||e>19&&e<=24?s="dimgray":(e>14&&e<=19||e>9&&e<=14||e>5&&e<=9||e>3&&e<=5||e<=3)&&(s="rgba(0, 102, 255, 0.8)"):s="dimgray",`radial-gradient(circle, ${i} 0%, black, ${s} 70%)`}#u(t,e,i){return Math.min(i,Math.max(e,t))}#p(t,e,i,s,r){if(!Number.isFinite(t))return(s+r)/2;const n=(t-e)/(i-e);return this.#u(s+n*(r-s),s,r)}#e(t){return Number.isFinite(t)?Math.min(100,Math.max(0,t)):NaN}#t(t,e){if(!Number.isFinite(t))return NaN;return(e||"").toLowerCase().includes("f")?5/9*(t-32):t}#f(t,e){const i=(e||"").toLowerCase();return Number.isFinite(t)?i.includes("f")?9*t/5+32:t:NaN}#i(t,e){if(!t)return e??0;const i=parseFloat(t.state);if(!Number.isFinite(i))return e??0;const s=(t.attributes.unit_of_measurement||"m/s").toLowerCase();return s.includes("m/s")?i:s.includes("km/h")||s.includes("kph")?i/3.6:s.includes("mph")?.44704*i:s.includes("kn")?.514444*i:i}#y(t,e=1){if(!Number.isFinite(t))return NaN;const i=Math.pow(10,e);return Math.round(t*i)/i}#m(t,e=1){return Number.isFinite(t)?this.#y(t,e).toLocaleString(void 0,{minimumFractionDigits:e,maximumFractionDigits:e}):"—"}set hass(t){this._hass=t,this.requestUpdate()}get hass(){return this._hass}static getConfigElement(){return document.createElement("simple-air-comfort-card-editor")}static getStubConfig(){return{name:"Air Comfort",temperature:"sensor.temperature",humidity:"sensor.humidity",decimals:1,default_wind_speed:0,temp_min:15,temp_max:35}}}customElements.define("simple-air-comfort-card",lt),window.customCards=window.customCards||[],window.customCards.push({type:"simple-air-comfort-card",name:"Simple Air Comfort Card",description:"Australian BoM apparent temperature + dew point (Arden Buck). Indoor-friendly defaults, macro-matched visuals.",preview:!0});class ht extends nt{static properties={hass:{type:Object},_config:{state:!0},_schema:{state:!0}};static styles=n`
    .wrap { padding: 8px 12px 16px; }
  `;connectedCallback(){super.connectedCallback(),window.loadCardHelpers?.().catch(()=>{})}set hass(t){this._hass=t,this.requestUpdate()}get hass(){return this._hass}setConfig(t){this._config={name:"Air Comfort",temperature:void 0,humidity:void 0,windspeed:void 0,decimals:1,default_wind_speed:0,temp_min:15,temp_max:35,...t??{}},this._schema=[{name:"name",selector:{text:{}}},{name:"temperature",required:!0,selector:{entity:{domain:"sensor"}}},{name:"humidity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"windspeed",selector:{entity:{domain:"sensor"}}},{name:"default_wind_speed",selector:{number:{min:0,max:50,step:.1,mode:"box",unit_of_measurement:"m/s"}}},{name:"decimals",selector:{number:{min:0,max:3,step:1,mode:"box"}}},{name:"temp_min",selector:{number:{min:-20,max:50,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"temp_max",selector:{number:{min:-20,max:60,step:.1,mode:"box",unit_of_measurement:"°C"}}}]}render(){return this.hass&&this._config?B`
      <div class="wrap">
        <ha-form
          .hass=${this.hass}
          .data=${this._config}
    ...
    `:B``}_computeLabel=t=>({name:"Name",temperature:"Temperature entity",humidity:"Humidity entity",windspeed:"Wind speed entity (optional)",default_wind_speed:"Default wind speed (m/s)",decimals:"Decimals",temp_min:"Dot temp min (°C)",temp_max:"Dot temp max (°C)"}[t.name]??t.name);_onValueChanged=t=>{t.stopPropagation();const e=t.detail.value;this._config=e,at(this,"config-changed",{config:e})}}customElements.define("simple-air-comfort-card-editor",ht);

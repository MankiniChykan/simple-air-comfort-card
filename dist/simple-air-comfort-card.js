 ...
 */class st extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let n=r._$litPart$;if(void 0===n){const t=i?.renderBefore??null;r._$litPart$=n=new X(e.insertBefore(F(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return B}}st._$litElement$=!0,st.finalized=!0,nt.litElementHydrateSupport?.({LitElement:st});const at=nt.litElementPolyfillSupport;at?.({LitElement:st}),(nt.litElementVersions??=[]).push("4.2.1");const ot=(t,e,i={},r)=>{const n=new CustomEvent(e,{detail:i,bubbles:r?.bubbles??!0,cancelable:r?.cancelable??!1,composed:r?.composed??!0});return t?.dispatchEvent(n),n},lt=["t_frosty_max","t_cold_max","t_chilly_max","t_cool_max","t_mild_max","t_warm_min","t_hot_min","t_boiling_min","t_perf_min","t_perf_max"];let mt=!1,ct=!1;class _t extends st{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0,this._ro=null,this._hass=void 0}static styles=s`
  ...
  `;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const t=this.renderRoot?.querySelector(".ratio")||this;if(!t)return;this._ro=new ResizeObserver(e=>{for(const i of e){const e=(i.contentBoxSize?.[0]?.inlineSize??i.contentRect?.width??t.clientWidth??300)/300;this.style.setProperty("--sac-scale",String(e))}}),this._ro.observe(t)})}disconnectedCallback(){try{this._ro?.disconnect()}catch(t){}this._ro=null,super.disconnectedCallback()}setConfig(t){const e=t=>{if(!t)return{};if(Array.isArray(t)){const e={};for(const i of t)i&&"object"==typeof i&&Object.assign(e,i);return e}return"object"==typeof t?t:{}},i=e(t?.temperature_anchors),r=e(t?.humidity_alert_anchors),n=e(t?.card_options);t={...t,...i,...r,...n};const s=String(t?.temp_display_unit??"auto").toLowerCase(),a="c"===s||"°c"===s?"c":"f"===s||"°f"===s?"f":"auto",o=String(t?.wind_display_unit??"ms").toLowerCase(),l=/km\/?h/.test(o)?"kmh":o.includes("mph")?"mph":o.includes("kn")?"kn":"ms",m=t=>null==t||""===t?NaN:Number(t),c=((t,e)=>{if(!Number.isFinite(t))return 0;switch(e){case"kmh":return t/3.6;case"mph":return.44704*t;case"kn":return.514444*t;default:return t}})(Number.isFinite(m(t?.default_wind_speed))?m(t.default_wind_speed):0,l);if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');if(!mt){const e=lt.filter(e=>e in t);e.length&&(console.warn("simple-air-comfort-card: Detected legacy/derived or alias keys in YAML. The card now derives hidden neighbors automatically from 10 anchors.\nOmit these keys from YAML:",e,"\nKeep only: t_frosty_min, t_cold_min, t_chilly_min, t_cool_min, t_mild_min, t_perfect_min, t_perfect_max, t_warm_max, t_hot_max, t_boiling_max."),mt=!0)}if(!ct){("t_perfect_min"in t||"t_perfect_max"in t)&&("t_perf_min"in t||"t_perf_max"in t)&&(console.warn("simple-air-comfort-card: Both alias sets present for PERFECT band. Using t_perfect_min/t_perfect_max and ignoring t_perf_min/t_perf_max."),ct=!0)}const _=t=>null==t||""===t?NaN:Number(t),h=Number.isFinite(_(t.ring_pct))?_(t.ring_pct):45,d=Number.isFinite(_(t.inner_pct))?_(t.inner_pct):46.5,p=Number.isFinite(_(t.y_offset_pct))?_(t.y_offset_pct):0,u=this.#t(t),f=this.#e(u);this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,feels_like:t.feels_like??"bom",decimals:Number.isFinite(_(t.decimals))?_(t.decimals):1,temp_display_unit:a,wind_display_unit:l,default_wind_speed:Number.isFinite(c)?c:0,cap_degrees:Number.isFinite(_(t.cap_degrees))?_(t.cap_degrees):6,t_frosty_min:f.t_frosty_min,t_frosty_max:f.t_frosty_max,t_cold_min:f.t_cold_min,t_cold_max:f.t_cold_max,t_chilly_min:f.t_chilly_min,t_chilly_max:f.t_chilly_max,t_cool_min:f.t_cool_min,t_cool_max:f.t_cool_max,t_mild_min:f.t_mild_min,t_mild_max:f.t_mild_max,t_perf_min:f.t_perf_min,t_perf_max:f.t_perf_max,t_warm_min:f.t_warm_min,t_warm_max:f.t_warm_max,t_hot_min:f.t_hot_min,t_hot_max:f.t_hot_max,t_boiling_min:f.t_boiling_min,t_boiling_max:f.t_boiling_max,ring_pct:h,inner_pct:d,center_pct:50,y_offset_pct:p,rh_left_inner_pct:Number.isFinite(_(t.rh_left_inner_pct))?_(t.rh_left_inner_pct):40,rh_right_inner_pct:Number.isFinite(_(t.rh_right_inner_pct))?_(t.rh_right_inner_pct):60}}render(){if(!this.hass||!this._config)return U``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e){this.style.setProperty("--sac-temp-bg","#2a2a2a");const{y_center:t}=this.#i();return U`
      ...
      `}const r=(t.attributes.unit_of_measurement||"°C").trim(),n=this.#o(Number.isFinite(+t.state)?+t.state:NaN,r),s=this.#l(Number.isFinite(+e.state)?+e.state:NaN),a=this.#m(i,this._config.default_wind_speed),o=s/100*this.#c(n),l=this.#_(o);let m,c;switch(String(this._config.feels_like||"bom")){case"wind_chill":m=this.#h(n,a),c="Wind Chill";break;case"heat_index":m=this.#d(n,s),c="Heat Index";break;case"humidex":m=this.#p(n,o),c="Humidex";break;default:m=this.#u(n,o,a),c="BoM AT"}const _=this.#f(l),h=this.#g(n),d=this.#b(s),p=this.#x(n),u=this.#n(_),f=this.#a(),g=this.#s(s,n,f),b=Number(this._config?.rh_left_inner_pct??40),x=Number(this._config?.rh_right_inner_pct??60),y=this.#y(),w=Number.isFinite(n)&&n>f.PERFECT.max,$=Number.isFinite(n)&&n<f.PERFECT.min,v=Number.isFinite(s)&&s<b,C=Number.isFinite(s)&&s>x,A=t=>`\n      color:white;\n      text-shadow:\n        0 0 calc(var(--sac-scale,1) * 2px)  rgba(255,255,255,.95),\n        0 0 calc(var(--sac-scale,1) * 10px) ${t},\n        0 0 calc(var(--sac-scale,1) * 22px) ${t},\n        0 0 calc(var(--sac-scale,1) * 40px) ${t},\n        0 0 calc(var(--sac-scale,1) * 70px) ${t},\n        0 0 calc(var(--sac-scale,1) * 100px) ${t};\n    `,T=w?A(y.hot):"",N=$?A(y.cold):"",E=v?A(y.humid):"",O=C?A(y.humid):"",F=this.#w(n),M=Number.isFinite(F)?this.#$(F+(this._config.y_offset_pct||0),0,100):50,R=this.#v(s),L=Number.isFinite(R)?this.#$(R,0,100):50,k=!Number.isFinite(s)||!Number.isFinite(n)||(s<b||s>x||n<f.PERFECT.min||n>f.PERFECT.max),S=this._config.decimals,H=this._config?.temp_display_unit||"auto",P="c"===H?"°C":"f"===H?"°F":r,D=this.#C(this.#A(l,P),S)+` ${P}`,I=this.#C(this.#A(m,P),S)+` ${P}`,W=this.#C(this.#A(n,P),S)+` ${P}`,B=Number.isFinite(s)?this.#T(s,S).toFixed(S)+" %":"—";return this.style.setProperty("--sac-temp-bg",p),U`
      <div class="ratio" role="img" aria-label="Air comfort dial">
        <div class="canvas">
          ${this.#r({Tc:n,RH:s,dpC:l,atC:m,dewText:_,tempText:h,rhText:d,ringGrad:u,innerGrad:g,xPct:L,yPct:M,outside:k,outUnit:P,d:S,dewOut:D,atOut:I,tempRaw:W,rhRaw:B,atTag:c,axisTopStyle:T,axisBottomStyle:N,axisLeftStyle:E,axisRightStyle:O})}
        </div>
      </div>
    `}#r({dewText:t,tempText:e,rhText:i,ringGrad:r,innerGrad:n,xPct:s,yPct:a,outside:o,dewOut:l,atOut:m,tempRaw:c,rhRaw:_,atTag:h,axisTopStyle:d="",axisBottomStyle:p="",axisLeftStyle:u="",axisRightStyle:f=""}){return U`
      <div class="header">
      ...
      <div class="corner tr">
        ...
        ${h?U`<span class="sublabel">${h}</span>`:z}
      </div>
    ...
    `}#u(t,e,i){return t+.33*e-.7*i-4}#h(t,e){if(!Number.isFinite(t)||!Number.isFinite(e))return NaN;const i=3.6*e;return 13.12+.6215*t-11.37*Math.pow(i,.16)+.3965*t*Math.pow(i,.16)}#d(t,e){if(!Number.isFinite(t)||!Number.isFinite(e))return NaN;const i=9*t/5+32,r=this.#l(e);return 5*(2.04901523*i-42.379+10.14333127*r+-.22475541*i*r+-.00683783*i*i+-.05481717*r*r+.00122874*i*i*r+85282e-8*i*r*r+-199e-8*i*i*r*r-32)/9}#p(t,e){return Number.isFinite(t)&&Number.isFinite(e)?t+.5555*(e-10):NaN}#c(t){return Number.isFinite(t)?t>=0?6.1121*Math.exp(t/(257.14+t)*(18.678-t/234.5)):6.1115*Math.exp(t/(279.82+t)*(23.036-t/333.7)):NaN}#_(t){if(!Number.isFinite(t)||t<=0)return NaN;let e=-80,i=60,r=0;for(let n=0;n<60;n++){r=(e+i)/2;const n=this.#c(r);if(!Number.isFinite(n))break;if(n>t?i=r:e=r,Math.abs(i-e)<1e-4)break}return r}#f(t){return Number.isFinite(t)?t<5?"Very Dry":t<=10?"Dry":t<=12.79?"Pleasant":t<=15.49?"Comfortable":t<=18.39?"Sticky Humid":t<=21.19?"Muggy":t<=23.9?"Sweltering":"Stifling":"Unknown"}#g(t){if(!Number.isFinite(t))return"N/A";const e=this.#a(),i=this.#N(t),r=[["FROSTY",e.FROSTY.min,e.FROSTY.max],["COLD",e.COLD.min,e.COLD.max],["CHILLY",e.CHILLY.min,e.CHILLY.max],["COOL",e.COOL.min,e.COOL.max],["MILD",e.MILD.min,e.MILD.max],["PERFECT",e.PERFECT.min,e.PERFECT.max],["WARM",e.WARM.min,e.WARM.max],["HOT",e.HOT.min,e.HOT.max],["BOILING",e.BOILING.min,e.BOILING.max]];for(const[t,e,n]of r)if(i>=e&&i<=n)return t;return i<r[0][1]?"FROSTY":"BOILING"}#b(t){if(!Number.isFinite(t))return"N/A";const e=Number(this._config?.rh_left_inner_pct??40),i=Number(this._config?.rh_right_inner_pct??60);return t<e?"DRY":t<=i?"COMFY":"HUMID"}#E(t){return Number.isFinite(t)?this.#g(t).toLowerCase():"n/a"}#O(t){const e=String(t||"").toLowerCase();return"frosty"===e?"mediumblue":"cold"===e?"dodgerblue":"chilly"===e?"deepskyblue":"cool"===e?"mediumaquamarine":"mild"===e?"seagreen":"perfect"===e?"limegreen":"warm"===e?"gold":"hot"===e?"orange":"boiling"===e?"crimson":"dimgray"}#x(t){const e=this.#E(t);return`radial-gradient(circle, rgba(100,100,100,0.15), rgba(100,100,100,0.15), rgba(100,100,100,0.15), ${this.#O(e)})`}#n(t){return`radial-gradient(circle, ${{"Very Dry":"deepskyblue",Dry:"mediumaquamarine",Pleasant:"limegreen",Comfortable:"yellowgreen","Sticky Humid":"yellow",Muggy:"gold",Sweltering:"orange",Stifling:"crimson"}[t]||"dimgray"}, 55%, rgba(100,100,100,0.15), rgba(100,100,100,0.15))`}#s(t,e,i){const r=this.#y(),n=Number(this._config?.rh_left_inner_pct??40),s=Number(this._config?.rh_right_inner_pct??60);let a="black";Number.isFinite(t)?(t<n||t>s)&&(a=r.humid):a="dimgray";const o=i.PERFECT.min,l=i.PERFECT.max;let m=r.inband;return Number.isFinite(e)&&(e>l?m=r.hot:e<o&&(m=r.cold)),`radial-gradient(circle, ${a} 0%, black, ${m} 70%)`}#$(t,e,i){return Math.min(i,Math.max(e,t))}#F(t,e,i){return e+(i-e)*t}#M(t,e,i){return(t-e)/(i-e)}#N(t){return Math.round(10*t)/10}#R(t){return t*t*(3-2*t)}#y(){return{hot:"var(--sac-col-hot, rgba(255,69,0,0.95))",cold:"var(--sac-col-cold, rgba(0,102,255,0.95))",humid:"var(--sac-col-humid-alert, hotpink)",inband:"var(--sac-col-inband, dimgray)"}}#a(){const t=this._config||{},e=(t,e)=>{const i=Number.isFinite(t)?t:e;return Math.round(10*i)/10},i={FROSTY:{min:e(t.t_frosty_min,0),max:e(t.t_frosty_max,2.9)},COLD:{min:e(t.t_cold_min,3),max:e(t.t_cold_max,4.9)},CHILLY:{min:e(t.t_chilly_min,5),max:e(t.t_chilly_max,8.9)},COOL:{min:e(t.t_cool_min,9),max:e(t.t_cool_max,13.9)},MILD:{min:e(t.t_mild_min,14),max:e(t.t_mild_max,18.9)},PERFECT:{min:e(t.t_perf_min,19),max:e(t.t_perf_max,23.9)},WARM:{min:e(t.t_warm_min,24),max:e(t.t_warm_max,27.9)},HOT:{min:e(t.t_hot_min,28),max:e(t.t_hot_max,34.9)},BOILING:{min:e(t.t_boiling_min,35),max:e(t.t_boiling_max,50)}},r=["FROSTY","COLD","CHILLY","COOL","MILD","PERFECT","WARM","HOT","BOILING"];for(let t=0;t<r.length;t++){const n=r[t-1]&&i[r[t-1]],s=i[r[t]];if(t>0){const t=e(n.max+.1,n.max+.1);s.min<t&&(s.min=t)}s.max<s.min&&(s.max=s.min)}return i}#L(t){return Math.round(10*t)/10}#t(t){const e="t_perfect_min"in t?t.t_perfect_min:t.t_perf_min,i="t_perfect_max"in t?t.t_perfect_max:t.t_perf_max;return{t_frosty_min:Number(t.t_frosty_min??0),t_cold_min:Number(t.t_cold_min??3),t_chilly_min:Number(t.t_chilly_min??5),t_cool_min:Number(t.t_cool_min??9),t_mild_min:Number(t.t_mild_min??14),t_perfect_min:Number(e??19),t_perfect_max:Number(i??23.9),t_warm_max:Number(t.t_warm_max??27.9),t_hot_max:Number(t.t_hot_max??34.9),t_boiling_max:Number(t.t_boiling_max??50)}}#e(t){const e=this.#L.bind(this),i=.1,r={frosty_min:e(t.t_frosty_min??0),cold_min:e(t.t_cold_min??3),chilly_min:e(t.t_chilly_min??5),cool_min:e(t.t_cool_min??9),mild_min:e(t.t_mild_min??14),perf_min:e(t.t_perfect_min??19),perf_max:e(t.t_perfect_max??23.9),warm_max:e(t.t_warm_max??27.9),hot_max:e(t.t_hot_max??34.9),boiling_max:e(t.t_boiling_max??50)};r.cold_min=Math.max(e(r.frosty_min+i),r.cold_min),r.chilly_min=Math.max(e(r.cold_min+i),r.chilly_min),r.cool_min=Math.max(e(r.chilly_min+i),r.cool_min),r.mild_min=Math.max(e(r.cool_min+i),r.mild_min),r.perf_min=Math.max(e(r.mild_min+i),Math.min(r.perf_min,e(r.perf_max-i))),r.perf_max=Math.max(e(r.perf_min+i),Math.min(r.perf_max,e(r.warm_max-i))),r.warm_max=Math.max(e(r.perf_max+i),Math.min(r.warm_max,e(r.hot_max-i))),r.hot_max=Math.max(e(r.warm_max+i),Math.min(r.hot_max,e(r.boiling_max-i)));return{t_frosty_min:r.frosty_min,t_cold_min:r.cold_min,t_chilly_min:r.chilly_min,t_cool_min:r.cool_min,t_mild_min:r.mild_min,t_perf_min:r.perf_min,t_perf_max:r.perf_max,t_warm_max:r.warm_max,t_hot_max:r.hot_max,t_boiling_max:r.boiling_max,t_frosty_max:e(r.cold_min-i),t_cold_max:e(r.chilly_min-i),t_chilly_max:e(r.cool_min-i),t_cool_max:e(r.mild_min-i),t_mild_max:e(r.perf_min-i),t_warm_min:e(r.perf_max+i),t_hot_min:e(r.warm_max+i),t_boiling_min:e(r.hot_max+i)}}#i(){const t=Number(this._config?.ring_pct??45),e=Number(this._config?.inner_pct??46.5),i=Number(this._config?.center_pct??50),r=t/2,n=e/100*(t/2);return{y_outer_bottom:i-r,y_outer_top:i+r,y_inner_bottom:i-n,y_inner_top:i+n,y_center:i,x_inner_left:50-n,x_inner_right:50+n}}#v(t){if(!Number.isFinite(t))return NaN;const{x_inner_left:e,x_inner_right:i}=this.#i(),r=Number(this._config?.rh_left_inner_pct??40),n=Number(this._config?.rh_right_inner_pct??60),s=this.#$(r,0,100),a=this.#$(Math.max(n,s+.1),0,100),o=this.#$(t,0,100),l=1e-6;if(s<=l&&o<=s)return 0;if(a>=100-l&&o>=a)return 100;if(o<=s){const t=this.#M(o,0,s);return this.#F(t,0,e)}if(o>=a){const t=this.#M(o,a,100);return this.#F(t,i,100)}{const t=this.#M(o,s,a);return this.#F(t,e,i)}}#w(t){const e=this.#i(),i=this.#a(),r=e.y_outer_bottom,n=e.y_inner_bottom,s=e.y_inner_top,a=e.y_outer_top,o=(t,e,i)=>{const r=i-e;return!Number.isFinite(r)||Math.abs(r)<1e-6?0:this.#$((t-e)/r,0,1)},l=i.FROSTY.min,m=i.MILD.min,c=r,_=t=>0+o(t,l,m)*(c-0),h=_(i.FROSTY.min),d=_(i.COLD.min),p=_(i.CHILLY.min),u=_(i.COOL.min),f=_(i.MILD.min),g=i.WARM.max,b=i.BOILING.max,x=a,y=x+o(i.HOT.max,g,b)*(100-x),w=[{t:i.FROSTY.min,y:h},{t:i.COLD.min,y:d},{t:i.CHILLY.min,y:p},{t:i.COOL.min,y:u},{t:i.MILD.min,y:f},{t:i.PERFECT.min,y:n},{t:i.PERFECT.max,y:s},{t:i.WARM.max,y:a},{t:i.HOT.max,y:y},{t:i.BOILING.max,y:100}];if(!Number.isFinite(t))return e.y_center;if(t<=w[0].t)return w[0].y;if(t>=w[w.length-1].t)return w[w.length-1].y;for(let e=0;e<w.length-1;e++){const r=w[e],n=w[e+1];if(t>=r.t&&t<=n.t){const e=this.#$((t-r.t)/(n.t-r.t),0,1),s=r.t===i.MILD.min&&n.t===i.PERFECT.min||r.t===i.PERFECT.min&&n.t===i.PERFECT.max||r.t===i.PERFECT.max&&n.t===i.WARM.max?e:this.#R(e);return r.y+(n.y-r.y)*s}}return e.y_center}#l(t){return Number.isFinite(t)?Math.min(100,Math.max(0,t)):NaN}#o(t,e){return Number.isFinite(t)?(e||"").toLowerCase().includes("f")?5/9*(t-32):t:NaN}#A(t,e){return Number.isFinite(t)?(e||"").toLowerCase().includes("f")?9*t/5+32:t:NaN}#m(t,e){if(!t)return e??0;const i=parseFloat(t.state);if(!Number.isFinite(i))return e??0;const r=(t.attributes.unit_of_measurement||"m/s").toLowerCase();return r.includes("m/s")?i:r.includes("km/h")||r.includes("kph")?i/3.6:r.includes("mph")?.44704*i:r.includes("kn")?.514444*i:i}#T(t,e=1){if(!Number.isFinite(t))return NaN;const i=Math.pow(10,e);return Math.round(t*i)/i}#C(t,e=1){return Number.isFinite(t)?this.#T(t,e).toLocaleString(void 0,{minimumFractionDigits:e,maximumFractionDigits:e}):"—"}set hass(t){this._hass=t,this.requestUpdate()}get hass(){return this._hass}static getConfigElement(){return document.createElement("simple-air-comfort-card-editor")}static getStubConfig(t){const e=t??document.querySelector("home-assistant")?.hass,i=e?.states??{},r=t=>{for(const[e,r]of Object.entries(i))if(t(e,r))return e},n=t=>t?.attributes?.device_class,s=t=>(t?.attributes?.unit_of_measurement||"").toLowerCase();return{type:"custom:simple-air-comfort-card",name:"Upstairs",temperature:r((t,e)=>t.startsWith("sensor.")&&"temperature"===n(e))||r((t,e)=>t.startsWith("sensor.")&&/°c|°f/.test(s(e)))||r(t=>t.startsWith("sensor.")),temp_display_unit:"auto",temperature_anchors:[{t_frosty_min:0},{t_cold_min:3},{t_chilly_min:5},{t_cool_min:9},{t_mild_min:14},{t_perfect_min:19},{t_perfect_max:23.9},{t_warm_max:27.9},{t_hot_max:34.9},{t_boiling_max:50},{cap_degrees:6}],humidity:r((t,e)=>t.startsWith("sensor.")&&"humidity"===n(e))||r((t,e)=>t.startsWith("sensor.")&&s(e).includes("%"))||r(t=>t.startsWith("sensor.")),humidity_alert_anchors:[{rh_left_inner_pct:40},{rh_right_inner_pct:60}],feels_like:"bom",windspeed:r((t,e)=>t.startsWith("sensor.")&&"wind_speed"===n(e))||r((t,e)=>t.startsWith("sensor.")&&/(m\/s|km\/h|kph|mph|kn)/.test(s(e))),wind_display_unit:"ms",default_wind_speed:.1,card_options:[{decimals:1},{y_offset_pct:0}]}}}customElements.get("simple-air-comfort-card")||customElements.define("simple-air-comfort-card",_t);class ht extends st{static properties={hass:{type:Object},_config:{state:!0}};static styles=s`
  ...
  `;connectedCallback(){super.connectedCallback(),window.loadCardHelpers?.().catch(()=>{})}_capDegrees(){const t=Number(this._config?.cap_degrees);return Number.isFinite(t)?Math.max(0,Math.min(20,t)):6}set hass(t){this._hass=t,this._autoFillDefaults(),this.requestUpdate()}get hass(){return this._hass}setConfig(t){const e=t=>{if(!t)return{};if(Array.isArray(t)){const e={};for(const i of t)i&&"object"==typeof i&&Object.assign(e,i);return e}return"object"==typeof t?t:{}},i={...t??{},...e(t?.temperature_anchors),...e(t?.humidity_alert_anchors),...e(t?.card_options)};this._config={name:"Area Name",temperature:void 0,humidity:void 0,windspeed:void 0,temp_display_unit:"auto",wind_display_unit:"ms",feels_like:"bom",decimals:1,default_wind_speed:.1,cap_degrees:6,t_frosty_min:0,t_frosty_max:2.9,t_cold_min:3,t_cold_max:4.9,t_chilly_min:5,t_chilly_max:8.9,t_cool_min:9,t_cool_max:13.9,t_mild_min:14,t_mild_max:18.9,t_perfect_min:19,t_perfect_max:23.9,t_warm_min:24,t_warm_max:27.9,t_hot_min:28,t_hot_max:34.9,t_boiling_min:35,t_boiling_max:50,y_offset_pct:0,rh_left_inner_pct:40,rh_right_inner_pct:60,...i},this._defaults={hot_max:34.9,warm_max:27.9,perf_max:23.9,perf_min:19,perfect_max:23.9,perfect_min:19,mild_min:14,cool_min:9,chilly_min:5,cold_min:3}}render(){if(!this.hass||!this._config)return U``;const t=`${this._capDegrees().toFixed(1)}°C`;return U`
      <div class="wrap">
        <!-- Entities -->
        ...
        <details class="panel">
          ...
          ${this._anchorRow("t_boiling_max","BOILING.max → Top of Card (100%)",U`Changes how far (HOT.max) is from the edge of the card.<br>${this._slimDerivedHelper("t_hot_max")}`,!1)}
          ${this._anchorRow("t_hot_max","HOT.max (Scales with BOILING.max)",U`Cap ±${t} from default. ${this._slimDerivedHelper("t_warm_max")}`,!0)}
          ${this._anchorRow("t_warm_max","WARM.max → Outer Ring Top",U`Cap ±${t} from default. ${this._slimDerivedHelper("t_perfect_max")}`,!0)}
          ${this._anchorRow("t_perfect_max","PERFECT.max → Inner Comfort Circle Top",U`High Temperature Alert :<br>Cap ±${t} from default.`,!0)}

          ${(()=>{const t=this._centerTemp(),e=Number(this._config?.t_perfect_min),i=Number(this._config?.t_perfect_max),r=Number.isFinite(e)&&Number.isFinite(i)?U`Midpoint of PERFECT band: (${e.toFixed(1)} → ${i.toFixed(1)}).<br>Updates automatically when either edge changes.`:U`Read-only. Midpoint of PERFECT band. Set PERFECT.min and PERFECT.max to compute.`;return U`
              <div class="row">
          ...
          ${this._anchorRow("t_perfect_min","PERFECT.min → Inner Comfort Circle Bottom",U`Low Temperature Alert Limit :<br>Cap±${t} from default. ${this._slimDerivedHelper("t_perfect_min")}`,!0)}
          ${this._anchorRow("t_mild_min","MILD.min → Outer Ring Bottom",U`Cap ±${t} from default. ${this._slimDerivedHelper("t_mild_min")}`,!0)}
          ${this._anchorRow("t_cool_min","COOL.min (Scales with FROSTY.min)",U`Cap ±${t} from default. ${this._slimDerivedHelper("t_cool_min")}`,!0)}
          ${this._anchorRow("t_chilly_min","CHILLY.min (Scales with FROSTY.min)",U`Cap ±${t} from default. ${this._slimDerivedHelper("t_chilly_min")}`,!0)}
          ${this._anchorRow("t_cold_min","COLD.min (Scales with FROSTY.min)",U`Cap ±${t} from default. ${this._slimDerivedHelper("t_cold_min")}`,!0)}
    ...
    `}_label=t=>{const e=t.name;return{name:"Name",temperature:"Temperature entity",humidity:"Humidity entity",windspeed:"Wind speed entity (optional)",feels_like:"Feels-like formula",default_wind_speed:`Default wind speed (${{ms:"m/s",kmh:"km/h",mph:"mph",kn:"kn"}[this._config?.wind_display_unit||"ms"]})`,decimals:"Decimals",rh_left_inner_pct:"Inner circle left RH (%)",rh_right_inner_pct:"Inner circle right RH (%)",y_offset_pct:"Vertical dot offset (%)"}[e]??e};_bandBaseColour(t){const e=String(t||"").toLowerCase();return"frosty"===e?"mediumblue":"cold"===e?"dodgerblue":"chilly"===e?"deepskyblue":"cool"===e?"mediumaquamarine":"mild"===e?"seagreen":"perfect"===e?"limegreen":"warm"===e?"gold":"hot"===e?"orange":"boiling"===e?"crimson":"dimgray"}_bandForAnchor(t){switch(t){case"t_boiling_max":return"boiling";case"t_hot_max":return"hot";case"t_warm_max":return"warm";case"t_perfect_max":case"t_perfect_min":return"perfect";case"t_mild_min":return"mild";case"t_cool_min":return"cool";case"t_chilly_min":return"chilly";case"t_cold_min":return"cold";case"t_frosty_min":return"frosty";default:return null}}_fmtC(t){return Number.isFinite(t)?`${Number(t).toFixed(1)}°C`:"—"}_slimDerivedHelper(t){const e=this._config||{},i={t_hot_max:["BOILING.min",e.t_boiling_min],t_warm_max:["HOT.min",e.t_hot_min],t_perfect_max:["WARM.min",e.t_warm_min],t_perfect_min:["MILD.max",e.t_mild_max],t_mild_min:["COOL.max",e.t_cool_max],t_cool_min:["CHILLY.max",e.t_chilly_max],t_chilly_min:["COLD.max",e.t_cold_max],t_cold_min:["FROSTY.max",e.t_frosty_max]}[t];return i?U`${i[0]} = ${this._fmtC(i[1])}`:z}_anchorRow(t,e,i,r){const n=Number(this._config?.[t]),s=Number.isFinite(n)?`${n.toFixed(1)} °C`:"—",a=this._bandForAnchor(t),o=a?this._bandBaseColour(a):null,l=r?this._capFor(t):null,m=!!l&&n<=l.lo,c=!!l&&n>=l.hi;return U`
      <div class="row">
    ...
    `}_rhRow(t,e){const i=Number(this._config?.[t]),r=Number.isFinite(i)?`${i.toFixed(1)} %`:"—",n=.1,s=Number(this._config?.rh_left_inner_pct??40),a=Number(this._config?.rh_right_inner_pct??60);let o=!1,l=!1;"rh_left_inner_pct"===t?(o=i<=0,l=i>=a-n):(o=i<=s+n,l=i>=100);const m=this._helper({name:t});return U`
      <div class="row">
        <div class="name">${e}</div>

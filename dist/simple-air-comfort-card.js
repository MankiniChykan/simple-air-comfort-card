 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const v=globalThis,$=v.trustedTypes,C=$?$.createPolicy("lit-html",{createHTML:t=>t}):void 0,A="$lit$",T=`lit$${Math.random().toFixed(9).slice(2)}$`,E="?"+T,N=`<${E}>`,R=document,O=()=>R.createComment(""),M=t=>null===t||"object"!=typeof t&&"function"!=typeof t,F=Array.isArray,L="[ \t\n\f\r]",S=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,k=/-->/g,P=/>/g,H=RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),I=/'/g,D=/"/g,B=/^(?:script|style|textarea|title)$/i,U=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),W=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),Y=new WeakMap,G=R.createTreeWalker(R,129);function j(t,e){if(!F(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==C?C.createHTML(e):e}const q=(t,e)=>{const i=t.length-1,r=[];let n,s=2===e?"<svg>":3===e?"<math>":"",a=S;for(let e=0;e<i;e++){const i=t[e];let o,l,m=-1,c=0;for(;c<i.length&&(a.lastIndex=c,l=a.exec(i),null!==l);)c=a.lastIndex,a===S?"!--"===l[1]?a=k:void 0!==l[1]?a=P:void 0!==l[2]?(B.test(l[2])&&(n=RegExp("</"+l[2],"g")),a=H):void 0!==l[3]&&(a=H):a===H?">"===l[0]?(a=n??S,m=-1):void 0===l[1]?m=-2:(m=a.lastIndex-l[2].length,o=l[1],a=void 0===l[3]?H:'"'===l[3]?D:I):a===D||a===I?a=H:a===k||a===P?a=S:(a=H,n=void 0);const _=a===H&&t[e+1].startsWith("/>")?" ":"";s+=a===S?i+N:m>=0?(r.push(o),i.slice(0,m)+A+i.slice(m)+T+_):i+T+(-2===m?e:_)}return[j(t,s+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),r]};class V{constructor({strings:t,_$litType$:e},i){let r;this.parts=[];let n=0,s=0;const a=t.length-1,o=this.parts,[l,m]=q(t,e);if(this.el=V.createElement(l,i),G.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(r=G.nextNode())&&o.length<a;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(A)){const e=m[s++],i=r.getAttribute(t).split(T),a=/([.?@])?(.*)/.exec(e);o.push({type:1,index:n,name:a[2],strings:i,ctor:"."===a[1]?Q:"?"===a[1]?tt:"@"===a[1]?et:Z}),r.removeAttribute(t)}else t.startsWith(T)&&(o.push({type:6,index:n}),r.removeAttribute(t));if(B.test(r.tagName)){const t=r.textContent.split(T),e=t.length-1;if(e>0){r.textContent=$?$.emptyScript:"";for(let i=0;i<e;i++)r.append(t[i],O()),G.nextNode(),o.push({type:2,index:++n});r.append(t[e],O())}}}else if(8===r.nodeType)if(r.data===E)o.push({type:2,index:n});else{let t=-1;for(;-1!==(t=r.data.indexOf(T,t+1));)o.push({type:7,index:n}),t+=T.length-1}n++}}static createElement(t,e){const i=R.createElement("template");return i.innerHTML=t,i}}function K(t,e,i=t,r){if(e===W)return e;let n=void 0!==r?i._$Co?.[r]:i._$Cl;const s=M(e)?void 0:e._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),void 0===s?n=void 0:(n=new s(t),n._$AT(t,i,r)),void 0!==r?(i._$Co??=[])[r]=n:i._$Cl=n),void 0!==n&&(e=K(t,n._$AS(t,e.values),n,r)),e}class J{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,r=(t?.creationScope??R).importNode(e,!0);G.currentNode=r;let n=G.nextNode(),s=0,a=0,o=i[0];for(;void 0!==o;){if(s===o.index){let e;2===o.type?e=new X(n,n.nextSibling,this,t):1===o.type?e=new o.ctor(n,o.name,o.strings,this,t):6===o.type&&(e=new it(n,this,t)),this._$AV.push(e),o=i[++a]}s!==o?.index&&(n=G.nextNode(),s++)}return G.currentNode=R,r}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,r){this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=K(this,t,e),M(t)?t===z||null==t||""===t?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==W&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>F(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==z&&M(this._$AH)?this._$AA.nextSibling.data=t:this.T(R.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,r="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=V.createElement(j(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(e);else{const t=new J(r,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=Y.get(t.strings);return void 0===e&&Y.set(t.strings,e=new V(t)),e}k(t){F(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,r=0;for(const n of t)r===e.length?e.push(i=new X(this.O(O()),this.O(O()),this,this.options)):i=e[r],i._$AI(n),r++;r<e.length&&(this._$AR(i&&i._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class Z{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,r,n){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=z}_$AI(t,e=this,i,r){const n=this.strings;let s=!1;if(void 0===n)t=K(this,t,e,0),s=!M(t)||t!==this._$AH&&t!==W,s&&(this._$AH=t);else{const r=t;let a,o;for(t=n[0],a=0;a<n.length-1;a++)o=K(this,r[i+a],e,a),o===W&&(o=this._$AH[a]),s||=!M(o)||o!==this._$AH[a],o===z?t=z:t!==z&&(t+=(o??"")+n[a+1]),this._$AH[a]=o}s&&!r&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Q extends Z{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}}class tt extends Z{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==z)}}class et extends Z{constructor(t,e,i,r,n){super(t,e,i,r,n),this.type=5}_$AI(t,e=this){if((t=K(this,t,e,0)??z)===W)return;const i=this._$AH,r=t===z&&i!==z||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==z&&(i===z||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class it{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){K(this,t)}}const rt=v.litHtmlPolyfillSupport;rt?.(V,X),(v.litHtmlVersions??=[]).push("3.3.1");const nt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class st extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let n=r._$litPart$;if(void 0===n){const t=i?.renderBefore??null;r._$litPart$=n=new X(e.insertBefore(O(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}st._$litElement$=!0,st.finalized=!0,nt.litElementHydrateSupport?.({LitElement:st});const at=nt.litElementPolyfillSupport;at?.({LitElement:st}),(nt.litElementVersions??=[]).push("4.2.1");const ot=(t,e,i,r)=>{const n=new Event(e,{bubbles:r?.bubbles??!0,cancelable:r?.cancelable??!1,composed:r?.composed??!0});return n.detail=i,t.dispatchEvent(n),n},lt=["t_frosty_max","t_cold_max","t_chilly_max","t_cool_max","t_mild_max","t_warm_min","t_hot_min","t_boiling_min","t_perf_min","t_perf_max"];let mt=!1,ct=!1;class _t extends st{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0,this._ro=null,this._hass=void 0}static styles=s`
  ...
  `;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const t=this.renderRoot?.querySelector(".ratio")||this;if(!t)return;this._ro=new ResizeObserver(e=>{for(const i of e){const e=(i.contentBoxSize?.[0]?.inlineSize??i.contentRect?.width??t.clientWidth??300)/300;this.style.setProperty("--sac-scale",String(e))}}),this._ro.observe(t)})}disconnectedCallback(){try{this._ro?.disconnect()}catch(t){}this._ro=null,super.disconnectedCallback()}setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');if(!mt){const e=lt.filter(e=>e in t);e.length&&(console.warn("simple-air-comfort-card: Detected legacy/derived or alias keys in YAML. The card now derives hidden neighbors automatically from 10 anchors.\nOmit these keys from YAML:",e,"\nKeep only: t_frosty_min, t_cold_min, t_chilly_min, t_cool_min, t_mild_min, t_perfect_min, t_perfect_max, t_warm_max, t_hot_max, t_boiling_max."),mt=!0)}if(!ct){("t_perfect_min"in t||"t_perfect_max"in t)&&("t_perf_min"in t||"t_perf_max"in t)&&(console.warn("simple-air-comfort-card: Both alias sets present for PERFECT band. Using t_perfect_min/t_perfect_max and ignoring t_perf_min/t_perf_max."),ct=!0)}const e=t=>null==t||""===t?NaN:Number(t),i=Number.isFinite(e(t.ring_pct))?e(t.ring_pct):45,r=Number.isFinite(e(t.inner_pct))?e(t.inner_pct):46.5,n=Number.isFinite(e(t.y_offset_pct))?e(t.y_offset_pct):0,s=this.#t(t),a=this.#e(s);this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,feels_like:t.feels_like??"bom",decimals:Number.isFinite(e(t.decimals))?e(t.decimals):1,default_wind_speed:Number.isFinite(e(t.default_wind_speed))?e(t.default_wind_speed):0,t_frosty_min:a.t_frosty_min,t_frosty_max:a.t_frosty_max,t_cold_min:a.t_cold_min,t_cold_max:a.t_cold_max,t_chilly_min:a.t_chilly_min,t_chilly_max:a.t_chilly_max,t_cool_min:a.t_cool_min,t_cool_max:a.t_cool_max,t_mild_min:a.t_mild_min,t_mild_max:a.t_mild_max,t_perf_min:a.t_perf_min,t_perf_max:a.t_perf_max,t_warm_min:a.t_warm_min,t_warm_max:a.t_warm_max,t_hot_min:a.t_hot_min,t_hot_max:a.t_hot_max,t_boiling_min:a.t_boiling_min,t_boiling_max:a.t_boiling_max,ring_pct:i,inner_pct:r,center_pct:50,y_offset_pct:n,rh_left_inner_pct:Number.isFinite(e(t.rh_left_inner_pct))?e(t.rh_left_inner_pct):40,rh_right_inner_pct:Number.isFinite(e(t.rh_right_inner_pct))?e(t.rh_right_inner_pct):60}}render(){if(!this.hass||!this._config)return U``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e){this.style.setProperty("--sac-temp-bg","#2a2a2a");const{y_center:t}=this.#i();return U`
      ...
      `}const r=(t.attributes.unit_of_measurement||"°C").trim(),n=this.#o(Number.isFinite(+t.state)?+t.state:NaN,r),s=this.#l(Number.isFinite(+e.state)?+e.state:NaN),a=this.#m(i,this._config.default_wind_speed),o=s/100*this.#c(n),l=this.#_(o);let m,c;switch(String(this._config.feels_like||"bom")){case"wind_chill":m=this.#h(n,a),c="Wind Chill";break;case"heat_index":m=this.#d(n,s),c="Heat Index";break;case"humidex":m=this.#p(n,o),c="Humidex";break;default:m=this.#u(n,o,a),c="BoM AT"}const _=this.#f(l),h=this.#g(n),d=this.#x(s),p=this.#b(n),u=this.#n(_),f=this.#a(),g=this.#s(s,n,f),x=Number(this._config?.rh_left_inner_pct??40),b=Number(this._config?.rh_right_inner_pct??60),y=this.#y(),w=Number.isFinite(n)&&n>f.PERFECT.max,v=Number.isFinite(n)&&n<f.PERFECT.min,$=Number.isFinite(s)&&s<x,C=Number.isFinite(s)&&s>b,A=t=>`\n      color:white;\n      text-shadow:\n        0 0 calc(var(--sac-scale,1) * 2px)  rgba(255,255,255,.95),\n        0 0 calc(var(--sac-scale,1) * 10px) ${t},\n        0 0 calc(var(--sac-scale,1) * 22px) ${t},\n        0 0 calc(var(--sac-scale,1) * 40px) ${t},\n        0 0 calc(var(--sac-scale,1) * 70px) ${t},\n        0 0 calc(var(--sac-scale,1) * 100px) ${t};\n    `,T=w?A(y.hot):"",E=v?A(y.cold):"",N=$?A(y.humid):"",R=C?A(y.humid):"",O=this.#w(n),M=Number.isFinite(O)?this.#v(O+(this._config.y_offset_pct||0),0,100):50,F=this.#$(s),L=Number.isFinite(F)?this.#v(F,0,100):50,S=!Number.isFinite(s)||!Number.isFinite(n)||(s<x||s>b||n<f.PERFECT.min||n>f.PERFECT.max),k=this._config.decimals,P=r,H=this.#C(this.#A(l,P),k)+` ${P}`,I=this.#C(this.#A(m,P),k)+` ${P}`,D=this.#C(this.#A(n,P),k)+` ${P}`,B=Number.isFinite(s)?this.#T(s,k).toFixed(k)+" %":"—";return this.style.setProperty("--sac-temp-bg",p),U`
      <div class="ratio" role="img" aria-label="Air comfort dial">
        <div class="canvas">
          ${this.#r({Tc:n,RH:s,dpC:l,atC:m,dewText:_,tempText:h,rhText:d,ringGrad:u,innerGrad:g,xPct:L,yPct:M,outside:S,outUnit:P,d:k,dewOut:H,atOut:I,tempRaw:D,rhRaw:B,atTag:c,axisTopStyle:T,axisBottomStyle:E,axisLeftStyle:N,axisRightStyle:R})}
        </div>
      </div>
    `}#r({dewText:t,tempText:e,rhText:i,ringGrad:r,innerGrad:n,xPct:s,yPct:a,outside:o,dewOut:l,atOut:m,tempRaw:c,rhRaw:_,atTag:h,axisTopStyle:d="",axisBottomStyle:p="",axisLeftStyle:u="",axisRightStyle:f=""}){return U`
      ...
      <div class="graphic" style="--sac-dewpoint-ring:${r}; --sac-inner-gradient:${n}">

 ...
 */class nt extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new Z(e.insertBefore(T(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return z}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const ot=rt.litElementPolyfillSupport;ot?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.1");class at extends nt{static properties={hass:{type:Object},_config:{state:!0}};static styles=n`
  ...
  `;setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" entities are required.');this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,decimals:Number.isFinite(t.decimals)?t.decimals:1,default_wind_speed:Number.isFinite(t.default_wind_speed)?t.default_wind_speed:0,temp_min:Number.isFinite(t.temp_min)?t.temp_min:15,temp_max:Number.isFinite(t.temp_max)?t.temp_max:35}}render(){if(!this.hass||!this._config)return I``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e)return I`<ha-card><div class="frame">
      ...
      </div></ha-card>`;const s=(t.attributes.unit_of_measurement||"°C").trim(),r=this.#t(parseFloat(t.state),s),n=this.#e(parseFloat(e.state)),o=this.#i(i,this._config.default_wind_speed),a=n/100*this.#s(r),l=this.#r(a),d=this.#n(r,a,o),h=this.#o(l),c=this.#a(r),u=this.#l(n),p=this.#d(r),m=this.#h(h),g=this.#c(n,r),{temp_min:f,temp_max:_}=this._config,$=this.#u(r,f,_,0,100),v=this.#p(n,0,100),b=this._config.decimals,y=s,w=this.#m(this.#g(l,y),b)+` ${y}`,x=this.#m(this.#g(d,y),b)+` ${y}`;return I`
          ...
          <div class="grid">
            ...
            <div class="dial-wrap">
              <div class="dial">
                ...
                <!-- floating dot -->
                <div class="dot" style="left:${v}%; bottom:${$}%"></div>
              </div>
            </div>

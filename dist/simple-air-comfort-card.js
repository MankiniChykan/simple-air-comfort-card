 ...
 */class nt extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new Z(e.insertBefore(P(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return B}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const ot=rt.litElementPolyfillSupport;ot?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.1");class at extends nt{static properties={hass:{type:Object},_config:{state:!0},_isNarrow:{state:!0}};constructor(){super(),this._isNarrow=!1,this._resizeObsInitialized=!1,this._resizeObs=null}static styles=n`
  ...
  `;setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" entities are required.');const e=t=>null==t||""===t?NaN:Number(t),i=Number.isFinite(e(t.temp_min))?e(t.temp_min):15,s=Number.isFinite(e(t.temp_max))?e(t.temp_max):35;if(s<=i)throw new Error("simple-air-comfort-card: temp_max must be greater than temp_min.");this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,decimals:Number.isFinite(e(t.decimals))?e(t.decimals):1,default_wind_speed:Number.isFinite(e(t.default_wind_speed))?e(t.default_wind_speed):0,temp_min:i,temp_max:s,size_mode:"large"===t.size_mode||"small"===t.size_mode?t.size_mode:"large",large_columns:Number.isFinite(e(t.large_columns))?e(t.large_columns):12,large_rows:Number.isFinite(e(t.large_rows))?e(t.large_rows):8,small_columns:Number.isFinite(e(t.small_columns))?e(t.small_columns):6,small_rows:Number.isFinite(e(t.small_rows))?e(t.small_rows):4}}render(){if(!this.hass||!this._config)return I``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e)return I`<ha-card>
        <div class="ratio">
          <div class="canvas">
            <div class="header">
      ...
      </ha-card>`;const s=(t.attributes.unit_of_measurement||"°C").trim(),r=t.state,n=e.state,o=this.#t(Number.isFinite(+r)?+r:NaN,s),a=this.#e(Number.isFinite(+n)?+n:NaN),l=this.#i(i,this._config.default_wind_speed),c=a/100*this.#s(o),d=this.#r(c),h=this.#n(o,c,l),m=this.#o(d),u=this.#a(o),p=this.#l(a),_=this.#c(o),g=this.#d(m),f=this.#h(a,o),{temp_min:b,temp_max:$}=this._config,y=this.#m(o,b,$,0,100),w=this.#u(a+.5,0,100),v=a<40||a>60||o<18||o>26.4,x=this._config.decimals,A=s,C=this.#p(this.#_(d,A),x)+` ${A}`,S=this.#p(this.#_(h,A),x)+` ${A}`;return I`

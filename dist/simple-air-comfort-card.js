 ...
 */class nt extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new G(e.insertBefore(M(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const at=rt.litElementPolyfillSupport;at?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.1");const ot=new URL("./sac_background_overlay.svg",import.meta.url).toString();class lt extends nt{static properties={hass:{type:Object},_config:{state:!0}};static styles=n`
  ...
  `;setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" entities are required.');this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,decimals:Number.isFinite(t.decimals)?t.decimals:1,default_wind_speed:Number.isFinite(t.default_wind_speed)?t.default_wind_speed:0}}render(){if(!this.hass||!this._config)return j``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e)return j`<ha-card>
      ...
      </ha-card>`;const s=(t.attributes.unit_of_measurement||"°C").trim(),r=this.#t(parseFloat(t.state),s),n=this.#e(parseFloat(e.state)),a=this.#i(i,this._config.default_wind_speed),o=n/100*this.#s(r),l=this.#r(o),d=this.#n(r,o,a),h=s,c=this._config.decimals,p=this.#a(r,h),u=this.#a(l,h),m=this.#a(d,h),f=n<35?"Dry":n>60?"Humid":"Comfy",_=r<18?"Cold":r>26?"Warm":"Mild",g=r>=20&&r<=24?"PERFECT":_.toUpperCase(),$=n>=35&&n<=60?"COMFY":f.toUpperCase(),v=(t,e,i)=>(t-e)/(i-e),b=Math.min(1,Math.max(0,v(n,0,100))),y=Math.min(1,Math.max(0,v(r,12,30))),A=(t,e=.5)=>.4*(t-e),w=`calc((var(--ring-size)) * ${A(b)} )`,E=`calc((var(--ring-size)) * ${A(y)} )`;return j`
      <ha-card>
        <!-- Header -->
        <div class="header">
          <div class="title">${this._config.name}</div>
          <div class="summary">${f}</div>
          <div class="sub">${_}</div>
        </div>

        <!-- Square canvas with centered overlay and dot -->
        <div class="canvas" style=${C={"--dot-x":w,"--dot-y":E},Object.entries(C).map(([t,e])=>`${t}: ${e}`).join("; ")}>
          <!-- Ring captions -->
  ...
  `;setConfig(t){this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,decimals:Number.isFinite(t.decimals)?t.decimals:1,default_wind_speed:Number.isFinite(t.default_wind_speed)?t.default_wind_speed:0}}get _name(){return this._config?.name??""}get _temperature(){return this._config?.temperature??""}get _humidity(){return this._config?.humidity??""}get _windspeed(){return this._config?.windspeed??""}get _decimals(){return Number.isFinite(this._config?.decimals)?this._config.decimals:1}get _defaultWind(){return Number.isFinite(this._config?.default_wind_speed)?this._config.default_wind_speed:0}render(){return this.hass?j`
      <div class="form">
        <div class="row">
          ...
          <ha-textfield .value=${this._name} @input=${t=>this.#d("name",t.target.value)} placeholder="Air Comfort"></ha-textfield>
        </div>
        ...
        <div class="row">
          ...
          <ha-entity-picker
            ...
            @value-changed=${t=>this.#d("temperature",t.detail.value)}
            allow-custom-entity
          ></ha-entity-picker>
        </div>
        ...
        <div class="row">
          ...
          <ha-entity-picker
            ...
            .includeDomains=${["sensor"]}
            @value-changed=${t=>this.#d("humidity",t.detail.value)}
            allow-custom-entity
          ></ha-entity-picker>
        </div>
        ...
        <div class="row">
          ...
          <ha-entity-picker
            ...
            .includeDomains=${["sensor"]}
            @value-changed=${t=>this.#d("windspeed",t.detail.value)}
            allow-custom-entity
          ></ha-entity-picker>
        </div>
        ...
        <div class="row">
          ...
          <ha-textfield type="number" inputmode="decimal" step="0.1" .value=${String(this._defaultWind)}
            @input=${t=>this.#h("default_wind_speed",t.target.value)}></ha-textfield>
        </div>

        <div class="row">
          <div><label>Decimals</label></div>
          <ha-textfield type="number" step="1" min="0" .value=${String(this._decimals)}
            @input=${t=>this.#h("decimals",t.target.value,0)}></ha-textfield>
        </div>
      </div>
    `:j``}#d(t,e){const i={...this._config??{}};""===e||null==e?delete i[t]:i[t]=e,this._config=i,((t,e,i,s)=>{const r=new Event(e,{bubbles:s?.bubbles??!0,cancelable:s?.cancelable??!1,composed:s?.composed??!0});r.detail=i,t.dispatchEvent(r)})(this,"config-changed",{config:i})}#h(t,e,i=0){const s=""===e?void 0:Number(e),r=Number.isFinite(s)?s:i;this.#d(t,r)}}customElements.define("simple-air-comfort-card-editor",dt);

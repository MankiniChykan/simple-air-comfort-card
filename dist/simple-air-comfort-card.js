 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $=globalThis,v=$.trustedTypes,C=v?v.createPolicy("lit-html",{createHTML:t=>t}):void 0,T="$lit$",A=`lit$${Math.random().toFixed(9).slice(2)}$`,N="?"+A,E=`<${N}>`,F=document,O=()=>F.createComment(""),k=t=>null===t||"object"!=typeof t&&"function"!=typeof t,M=Array.isArray,L="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,S=/-->/g,H=/>/g,P=RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),D=/'/g,I=/"/g,B=/^(?:script|style|textarea|title)$/i,W=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),U=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),Y=new WeakMap,G=F.createTreeWalker(F,129);function j(t,e){if(!M(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==C?C.createHTML(e):e}const q=(t,e)=>{const i=t.length-1,r=[];let n,s=2===e?"<svg>":3===e?"<math>":"",a=R;for(let e=0;e<i;e++){const i=t[e];let o,m,_=-1,l=0;for(;l<i.length&&(a.lastIndex=l,m=a.exec(i),null!==m);)l=a.lastIndex,a===R?"!--"===m[1]?a=S:void 0!==m[1]?a=H:void 0!==m[2]?(B.test(m[2])&&(n=RegExp("</"+m[2],"g")),a=P):void 0!==m[3]&&(a=P):a===P?">"===m[0]?(a=n??R,_=-1):void 0===m[1]?_=-2:(_=a.lastIndex-m[2].length,o=m[1],a=void 0===m[3]?P:'"'===m[3]?I:D):a===I||a===D?a=P:a===S||a===H?a=R:(a=P,n=void 0);const c=a===P&&t[e+1].startsWith("/>")?" ":"";s+=a===R?i+E:_>=0?(r.push(o),i.slice(0,_)+T+i.slice(_)+A+c):i+A+(-2===_?e:c)}return[j(t,s+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),r]};class V{constructor({strings:t,_$litType$:e},i){let r;this.parts=[];let n=0,s=0;const a=t.length-1,o=this.parts,[m,_]=q(t,e);if(this.el=V.createElement(m,i),G.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(r=G.nextNode())&&o.length<a;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(T)){const e=_[s++],i=r.getAttribute(t).split(A),a=/([.?@])?(.*)/.exec(e);o.push({type:1,index:n,name:a[2],strings:i,ctor:"."===a[1]?Q:"?"===a[1]?tt:"@"===a[1]?et:Z}),r.removeAttribute(t)}else t.startsWith(A)&&(o.push({type:6,index:n}),r.removeAttribute(t));if(B.test(r.tagName)){const t=r.textContent.split(A),e=t.length-1;if(e>0){r.textContent=v?v.emptyScript:"";for(let i=0;i<e;i++)r.append(t[i],O()),G.nextNode(),o.push({type:2,index:++n});r.append(t[e],O())}}}else if(8===r.nodeType)if(r.data===N)o.push({type:2,index:n});else{let t=-1;for(;-1!==(t=r.data.indexOf(A,t+1));)o.push({type:7,index:n}),t+=A.length-1}n++}}static createElement(t,e){const i=F.createElement("template");return i.innerHTML=t,i}}function K(t,e,i=t,r){if(e===U)return e;let n=void 0!==r?i._$Co?.[r]:i._$Cl;const s=k(e)?void 0:e._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),void 0===s?n=void 0:(n=new s(t),n._$AT(t,i,r)),void 0!==r?(i._$Co??=[])[r]=n:i._$Cl=n),void 0!==n&&(e=K(t,n._$AS(t,e.values),n,r)),e}class J{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,r=(t?.creationScope??F).importNode(e,!0);G.currentNode=r;let n=G.nextNode(),s=0,a=0,o=i[0];for(;void 0!==o;){if(s===o.index){let e;2===o.type?e=new X(n,n.nextSibling,this,t):1===o.type?e=new o.ctor(n,o.name,o.strings,this,t):6===o.type&&(e=new it(n,this,t)),this._$AV.push(e),o=i[++a]}s!==o?.index&&(n=G.nextNode(),s++)}return G.currentNode=F,r}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,r){this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=K(this,t,e),k(t)?t===z||null==t||""===t?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==U&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>M(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==z&&k(this._$AH)?this._$AA.nextSibling.data=t:this.T(F.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,r="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=V.createElement(j(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(e);else{const t=new J(r,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=Y.get(t.strings);return void 0===e&&Y.set(t.strings,e=new V(t)),e}k(t){M(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,r=0;for(const n of t)r===e.length?e.push(i=new X(this.O(O()),this.O(O()),this,this.options)):i=e[r],i._$AI(n),r++;r<e.length&&(this._$AR(i&&i._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class Z{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,r,n){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=z}_$AI(t,e=this,i,r){const n=this.strings;let s=!1;if(void 0===n)t=K(this,t,e,0),s=!k(t)||t!==this._$AH&&t!==U,s&&(this._$AH=t);else{const r=t;let a,o;for(t=n[0],a=0;a<n.length-1;a++)o=K(this,r[i+a],e,a),o===U&&(o=this._$AH[a]),s||=!k(o)||o!==this._$AH[a],o===z?t=z:t!==z&&(t+=(o??"")+n[a+1]),this._$AH[a]=o}s&&!r&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Q extends Z{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}}class tt extends Z{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==z)}}class et extends Z{constructor(t,e,i,r,n){super(t,e,i,r,n),this.type=5}_$AI(t,e=this){if((t=K(this,t,e,0)??z)===U)return;const i=this._$AH,r=t===z&&i!==z||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==z&&(i===z||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class it{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){K(this,t)}}const rt=$.litHtmlPolyfillSupport;rt?.(V,X),($.litHtmlVersions??=[]).push("3.3.1");const nt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class st extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let n=r._$litPart$;if(void 0===n){const t=i?.renderBefore??null;r._$litPart$=n=new X(e.insertBefore(O(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return U}}st._$litElement$=!0,st.finalized=!0,nt.litElementHydrateSupport?.({LitElement:st});const at=nt.litElementPolyfillSupport;at?.({LitElement:st}),(nt.litElementVersions??=[]).push("4.2.1");const ot=(t,e,i={},r)=>{const n=new CustomEvent(e,{detail:i,bubbles:r?.bubbles??!0,cancelable:r?.cancelable??!1,composed:r?.composed??!0});return t?.dispatchEvent(n),n},mt=["t_frosty_max","t_cold_max","t_chilly_max","t_cool_max","t_mild_max","t_warm_min","t_hot_min","t_boiling_min","t_perf_min","t_perf_max"];let _t=!1,lt=!1;const ct={indoor:{t_boiling_max:42,t_hot_max:31,t_warm_max:26,t_perfect_max:23.5,t_perfect_min:20.5,t_mild_min:18,t_cool_min:16,t_chilly_min:12,t_cold_min:8,t_frosty_min:0},outdoor:{t_boiling_max:48,t_hot_max:36,t_warm_max:30,t_perfect_max:26,t_perfect_min:20,t_mild_min:16,t_cool_min:12,t_chilly_min:6,t_cold_min:2,t_frosty_min:-10}},ht=t=>"outdoor"===String(t||"").toLowerCase()?"outdoor":"indoor";class dt extends st{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0,this._ro=null,this._hass=void 0}static styles=s`
  ...
  `;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const t=this.renderRoot?.querySelector(".ratio")||this;if(!t)return;this._ro=new ResizeObserver(e=>{for(const i of e){const e=(i.contentBoxSize?.[0]?.inlineSize??i.contentRect?.width??t.clientWidth??300)/300;this.style.setProperty("--sac-scale",String(e))}}),this._ro.observe(t)})}disconnectedCallback(){try{this._ro?.disconnect()}catch(t){}this._ro=null,super.disconnectedCallback()}setConfig(t){const e=t=>{if(!t)return{};if(Array.isArray(t)){const e={};for(const i of t)i&&"object"==typeof i&&Object.assign(e,i);return e}return"object"==typeof t?t:{}},i=e(t?.temperature_anchors),r=e(t?.humidity_alert_anchors),n=e(t?.card_options);t={...t,...i,...r,...n};const s=(()=>{const e=String(t?.icon_position??"left").toLowerCase();return"right"===e||"bottom"===e?e:"left"})(),a=ht(t?.temp_preset),o=t?.icon&&String(t.icon)||"mdi:home-account",m=String(t?.temp_display_unit??"auto").toLowerCase(),_="c"===m||"°c"===m?"c":"f"===m||"°f"===m?"f":"auto",l=String(t?.wind_display_unit??"ms").toLowerCase(),c=/km\/?h/.test(l)?"kmh":l.includes("mph")?"mph":l.includes("kn")?"kn":"ms",h=t=>null==t||""===t?NaN:Number(t),d=((t,e)=>{if(!Number.isFinite(t))return 0;switch(e){case"kmh":return t/3.6;case"mph":return.44704*t;case"kn":return.514444*t;default:return t}})(Number.isFinite(h(t?.default_wind_speed))?h(t.default_wind_speed):0,c);if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');if(!_t){const e=mt.filter(e=>e in t);e.length&&(console.warn("simple-air-comfort-card: Detected legacy/derived or alias keys in YAML. The card now derives hidden neighbors automatically from 10 anchors.\nOmit these keys from YAML:",e,"\nKeep only: t_frosty_min, t_cold_min, t_chilly_min, t_cool_min, t_mild_min, t_perfect_min, t_perfect_max, t_warm_max, t_hot_max, t_boiling_max."),_t=!0)}if(!lt){("t_perfect_min"in t||"t_perfect_max"in t)&&("t_perf_min"in t||"t_perf_max"in t)&&(console.warn("simple-air-comfort-card: Both alias sets present for PERFECT band. Using t_perfect_min/t_perfect_max and ignoring t_perf_min/t_perf_max."),lt=!0)}const p=t=>null==t||""===t?NaN:Number(t),u=Number.isFinite(p(t.ring_pct))?p(t.ring_pct):45,f=Number.isFinite(p(t.inner_pct))?p(t.inner_pct):46.5,g=Number.isFinite(p(t.y_offset_pct))?p(t.y_offset_pct):0,x=this.#t(t,a),b=this.#e(x,a);this._config={temp_preset:a,name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,feels_like:t.feels_like??"bom",decimals:Number.isFinite(p(t.decimals))?p(t.decimals):1,temp_display_unit:_,wind_display_unit:c,default_wind_speed:Number.isFinite(d)?d:0,icon:o,icon_position:s,cap_degrees:Number.isFinite(p(t.cap_degrees))?p(t.cap_degrees):6,t_frosty_min:b.t_frosty_min,t_frosty_max:b.t_frosty_max,t_cold_min:b.t_cold_min,t_cold_max:b.t_cold_max,t_chilly_min:b.t_chilly_min,t_chilly_max:b.t_chilly_max,t_cool_min:b.t_cool_min,t_cool_max:b.t_cool_max,t_mild_min:b.t_mild_min,t_mild_max:b.t_mild_max,t_perf_min:b.t_perf_min,t_perf_max:b.t_perf_max,t_warm_min:b.t_warm_min,t_warm_max:b.t_warm_max,t_hot_min:b.t_hot_min,t_hot_max:b.t_hot_max,t_boiling_min:b.t_boiling_min,t_boiling_max:b.t_boiling_max,ring_pct:u,inner_pct:f,center_pct:50,y_offset_pct:g,rh_left_inner_pct:Number.isFinite(p(t.rh_left_inner_pct))?p(t.rh_left_inner_pct):40,rh_right_inner_pct:Number.isFinite(p(t.rh_right_inner_pct))?p(t.rh_right_inner_pct):60}}render(){if(!this.hass||!this._config)return W``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e){this.style.setProperty("--sac-temp-bg","#2a2a2a");const{y_center:t}=this.#i();return W`
      ...
      `}const r=(t.attributes.unit_of_measurement||"°C").trim(),n=this.#o(Number.isFinite(+t.state)?+t.state:NaN,r),s=this.#m(Number.isFinite(+e.state)?+e.state:NaN),a=this.#_(i,this._config.default_wind_speed),o=s/100*this.#l(n),m=this.#c(o);let _,l;switch(String(this._config.feels_like||"bom")){case"wind_chill":_=this.#h(n,a),l="Wind Chill";break;case"heat_index":_=this.#d(n,s),l="Heat Index";break;case"humidex":_=this.#p(n,o),l="Humidex";break;default:_=this.#u(n,o,a),l="BoM AT"}const c=this.#f(m),h=this.#g(n),d=this.#x(s),p=this.#b(n),u=this.#n(c),f=this.#a(),g=this.#s(s,n,f),x=this.#y(n),b=Number(this._config?.rh_left_inner_pct??40),y=Number(this._config?.rh_right_inner_pct??60),w=this.#w(),$=Number.isFinite(n)&&n>f.PERFECT.max,v=Number.isFinite(n)&&n<f.PERFECT.min,C=Number.isFinite(s)&&s<b,T=Number.isFinite(s)&&s>y,A=t=>`\n      color:white;\n      text-shadow:\n        0 0 calc(var(--sac-scale,1) * 2px)  rgba(255,255,255,.95),\n        0 0 calc(var(--sac-scale,1) * 10px) ${t},\n        0 0 calc(var(--sac-scale,1) * 22px) ${t},\n        0 0 calc(var(--sac-scale,1) * 40px) ${t},\n        0 0 calc(var(--sac-scale,1) * 70px) ${t},\n        0 0 calc(var(--sac-scale,1) * 100px) ${t};\n    `,N=$?A(w.hot):"",E=v?A(w.cold):"",F=C?A(w.humid):"",O=T?A(w.humid):"",k=this.#$(n),M=Number.isFinite(k)?this.#v(k+(this._config.y_offset_pct||0),0,100):50,L=this.#C(s),R=Number.isFinite(L)?this.#v(L,0,100):50,S=!Number.isFinite(s)||!Number.isFinite(n)||(s<b||s>y||n<f.PERFECT.min||n>f.PERFECT.max),H=this._config.decimals,P=this._config?.temp_display_unit||"auto",D="c"===P?"°C":"f"===P?"°F":r,I=this.#T(this.#A(m,D),H)+` ${D}`,B=this.#T(this.#A(_,D),H)+` ${D}`,U=this.#T(this.#A(n,D),H)+` ${D}`,Y=Number.isFinite(s)?this.#N(s,H).toFixed(H)+" %":"—";return this.style.setProperty("--sac-temp-bg",p),W`
      <div class="ratio" role="img" aria-label="Air comfort dial">
        <!-- Temperature-tinted icon puck: sits below content (z:-1), coords via inline style -->
        ${Number.isFinite(n)?W`
          ${(()=>{const t=String(this._config.icon_position||"left");let e="10%",i="50%";"right"===t&&(e="90%",i="50%"),"bottom"===t&&(e="50%",i="90%");return W`
              <div class="icon-puck" style=${`\n              left:${e};\n              top:${i};\n              transform: translate(-50%, -50%) scale(0.7);\n              background:${x};\n            `}>
        ...
        <div class="canvas">
          ${this.#r({Tc:n,RH:s,dpC:m,atC:_,dewText:c,tempText:h,rhText:d,ringGrad:u,innerGrad:g,xPct:R,yPct:M,outside:S,outUnit:D,d:H,dewOut:I,atOut:B,tempRaw:U,rhRaw:Y,atTag:l,axisTopStyle:N,axisBottomStyle:E,axisLeftStyle:F,axisRightStyle:O})}
        </div>
      </div>
    `}#r({dewText:t,tempText:e,rhText:i,ringGrad:r,innerGrad:n,xPct:s,yPct:a,outside:o,dewOut:m,atOut:_,tempRaw:l,rhRaw:c,atTag:h,axisTopStyle:d="",axisBottomStyle:p="",axisLeftStyle:u="",axisRightStyle:f=""}){return W`
      <div class="header">
  ...
  `;connectedCallback(){super.connectedCallback(),window.loadCardHelpers?.().catch(()=>{})}_capDegrees(){const t=Number(this._config?.cap_degrees);return Number.isFinite(t)?Math.max(0,Math.min(20,t)):6}set hass(t){this._hass=t,this._autoFillDefaults(),this.requestUpdate()}get hass(){return this._hass}setConfig(t){const e=t=>{if(!t)return{};if(Array.isArray(t)){const e={};for(const i of t)i&&"object"==typeof i&&Object.assign(e,i);return e}return"object"==typeof t?t:{}},i={...t??{},...e(t?.temperature_anchors),...e(t?.humidity_alert_anchors),...e(t?.card_options)},r=ht(i?.temp_preset),n=ct[r];this._config={name:"Area Name",temperature:void 0,humidity:void 0,windspeed:void 0,temp_display_unit:"auto",wind_display_unit:"ms",feels_like:"bom",decimals:1,default_wind_speed:.1,cap_degrees:6,temp_preset:r,icon_position:"left",t_frosty_min:n.t_frosty_min,t_cold_min:n.t_cold_min,t_chilly_min:n.t_chilly_min,t_cool_min:n.t_cool_min,t_mild_min:n.t_mild_min,t_perfect_min:n.t_perfect_min,t_perfect_max:n.t_perfect_max,t_warm_max:n.t_warm_max,t_hot_max:n.t_hot_max,t_boiling_max:n.t_boiling_max,y_offset_pct:0,rh_left_inner_pct:40,rh_right_inner_pct:60,...i},this._defaults={hot_max:n.t_hot_max,warm_max:n.t_warm_max,perf_max:n.t_perfect_max,perf_min:n.t_perfect_min,perfect_max:n.t_perfect_max,perfect_min:n.t_perfect_min,mild_min:n.t_mild_min,cool_min:n.t_cool_min,chilly_min:n.t_chilly_min,cold_min:n.t_cold_min},this._config=this._applyTempsRowBiDirectional(this._config)}_reseedAnchorsFromPreset(t){const e=ht(t),i=ct[e],r={...this._config||{}};r.temp_preset=e,r.t_boiling_max=i.t_boiling_max,r.t_hot_max=i.t_hot_max,r.t_warm_max=i.t_warm_max,r.t_perfect_max=i.t_perfect_max,r.t_perfect_min=i.t_perfect_min,r.t_mild_min=i.t_mild_min,r.t_cool_min=i.t_cool_min,r.t_chilly_min=i.t_chilly_min,r.t_cold_min=i.t_cold_min,r.t_frosty_min=i.t_frosty_min,this._defaults={hot_max:i.t_hot_max,warm_max:i.t_warm_max,perf_max:i.t_perfect_max,perf_min:i.t_perfect_min,perfect_max:i.t_perfect_max,perfect_min:i.t_perfect_min,mild_min:i.t_mild_min,cool_min:i.t_cool_min,chilly_min:i.t_chilly_min,cold_min:i.t_cold_min},this._config=this._applyTempsRowBiDirectional(r,["t_boiling_max","t_hot_max","t_warm_max","t_perfect_max","t_perfect_min","t_mild_min","t_cool_min","t_chilly_min","t_cold_min","t_frosty_min"]),ot(this,"config-changed",{config:this._persistKeys(this._config)})}render(){if(!this.hass||!this._config)return W``;const t=`${this._capDegrees().toFixed(1)}°C`;return W`
      <div class="wrap">
        ...
        <details class="panel">
          ...
          ${this._anchorRow("t_boiling_max","BOILING.max → Top of Card (100%)",W`Changes how far (HOT.max) is from the edge of the card.<br>${this._slimDerivedHelper("t_hot_max")}`,!1)}
          ${this._anchorRow("t_hot_max","HOT.max (Scales with BOILING.max)",W`Cap ±${t} from default. ${this._slimDerivedHelper("t_warm_max")}`,!0)}
          ${this._anchorRow("t_warm_max","WARM.max → Outer Ring Top",W`Cap ±${t} from default. ${this._slimDerivedHelper("t_perfect_max")}`,!0)}
          ${this._anchorRow("t_perfect_max","PERFECT.max → Inner Comfort Circle Top",W`High Temperature Alert :<br>Cap ±${t} from default.`,!0)}

          ${(()=>{const t=this._centerTemp(),e=Number(this._config?.t_perfect_min),i=Number(this._config?.t_perfect_max),r=Number.isFinite(e)&&Number.isFinite(i)?W`Midpoint of PERFECT band: (${e.toFixed(1)} → ${i.toFixed(1)}).<br>Updates automatically when either edge changes.`:W`Read-only. Midpoint of PERFECT band. Set PERFECT.min and PERFECT.max to compute.`;return W`
              <div class="row">
          ...
          ${this._anchorRow("t_perfect_min","PERFECT.min → Inner Comfort Circle Bottom",W`Low Temperature Alert Limit :<br>Cap±${t} from default. ${this._slimDerivedHelper("t_perfect_min")}`,!0)}
          ${this._anchorRow("t_mild_min","MILD.min → Outer Ring Bottom",W`Cap ±${t} from default. ${this._slimDerivedHelper("t_mild_min")}`,!0)}
          ${this._anchorRow("t_cool_min","COOL.min (Scales with FROSTY.min)",W`Cap ±${t} from default. ${this._slimDerivedHelper("t_cool_min")}`,!0)}
          ${this._anchorRow("t_chilly_min","CHILLY.min (Scales with FROSTY.min)",W`Cap ±${t} from default. ${this._slimDerivedHelper("t_chilly_min")}`,!0)}
          ${this._anchorRow("t_cold_min","COLD.min (Scales with FROSTY.min)",W`Cap ±${t} from default. ${this._slimDerivedHelper("t_cold_min")}`,!0)}
          ...
          <ha-form
            .hass=${this.hass}
            .data=${this._config}
            .schema=${[{name:"temp_preset",selector:{select:{mode:"dropdown",options:[{value:"indoor",label:"Indoor Temp Comfort Scale"},{value:"outdoor",label:"Outdoor Temp Comfort Scale"}]}}}]}
            .computeLabel=${this._label}
            .computeHelper=${this._helper}
            @value-changed=${this._onMiscChange}>
          </ha-form>
        ...
        <details class="panel">
          ...
          <ha-form
            .hass=${this.hass}
            .data=${this._config}
            .schema=${[{name:"icon",selector:{icon:{}}},{name:"icon_position",selector:{select:{mode:"dropdown",options:[{value:"left",label:"Left (default)"},{value:"right",label:"Right"},{value:"bottom",label:"Bottom"}]}}},{name:"decimals",selector:{number:{min:0,max:3,step:1,mode:"box"}}},{name:"y_offset_pct",selector:{number:{min:-30,max:30,step:.5,mode:"box",unit_of_measurement:"%"}}}]}
            .computeLabel=${this._label}
            .computeHelper=${this._helper}
            @value-changed=${this._onMiscChange}>
          </ha-form>
    ...
    `}_label=t=>{const e=t.name;return{name:"Name",temperature:"Temperature entity",humidity:"Humidity entity",windspeed:"Wind speed entity (optional)",feels_like:"Feels-like formula",temp_preset:"Temperature preset",default_wind_speed:`Default wind speed (${{ms:"m/s",kmh:"km/h",mph:"mph",kn:"kn"}[this._config?.wind_display_unit||"ms"]})`,decimals:"Decimals",rh_left_inner_pct:"Inner circle left RH (%)",rh_right_inner_pct:"Inner circle right RH (%)",icon:"Icon",icon_position:"Icon puck position",y_offset_pct:"Vertical dot offset (%)"}[e]??e};_bandBaseColour(t){const e=String(t||"").toLowerCase();return"frosty"===e?"mediumblue":"cold"===e?"dodgerblue":"chilly"===e?"deepskyblue":"cool"===e?"mediumaquamarine":"mild"===e?"seagreen":"perfect"===e?"limegreen":"warm"===e?"gold":"hot"===e?"orange":"boiling"===e?"crimson":"dimgray"}_bandForAnchor(t){switch(t){case"t_boiling_max":return"boiling";case"t_hot_max":return"hot";case"t_warm_max":return"warm";case"t_perfect_max":case"t_perfect_min":return"perfect";case"t_mild_min":return"mild";case"t_cool_min":return"cool";case"t_chilly_min":return"chilly";case"t_cold_min":return"cold";case"t_frosty_min":return"frosty";default:return null}}_fmtC(t){return Number.isFinite(t)?`${Number(t).toFixed(1)}°C`:"—"}_slimDerivedHelper(t){const e=this._config||{},i={t_hot_max:["BOILING.min",e.t_boiling_min],t_warm_max:["HOT.min",e.t_hot_min],t_perfect_max:["WARM.min",e.t_warm_min],t_perfect_min:["MILD.max",e.t_mild_max],t_mild_min:["COOL.max",e.t_cool_max],t_cool_min:["CHILLY.max",e.t_chilly_max],t_chilly_min:["COLD.max",e.t_cold_max],t_cold_min:["FROSTY.max",e.t_frosty_max]}[t];return i?W`${i[0]} = ${this._fmtC(i[1])}`:z}_anchorRow(t,e,i,r){const n=Number(this._config?.[t]),s=Number.isFinite(n)?`${n.toFixed(1)} °C`:"—",a=this._bandForAnchor(t),o=a?this._bandBaseColour(a):null,m=r?this._capFor(t):null,_=!!m&&n<=m.lo,l=!!m&&n>=m.hi;return W`
      <div class="row">
    ...
    `}_rhRow(t,e){const i=Number(this._config?.[t]),r=Number.isFinite(i)?`${i.toFixed(1)} %`:"—",n=.1,s=Number(this._config?.rh_left_inner_pct??40),a=Number(this._config?.rh_right_inner_pct??60);let o=!1,m=!1;"rh_left_inner_pct"===t?(o=i<=0,m=i>=a-n):(o=i<=s+n,m=i>=100);const _=this._helper({name:t});return W`
      <div class="row">
        <div class="name">${e}</div>

 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,v=w.trustedTypes,C=v?v.createPolicy("lit-html",{createHTML:t=>t}):void 0,A="$lit$",T=`lit$${Math.random().toFixed(9).slice(2)}$`,N="?"+T,E=`<${N}>`,S=document,F=()=>S.createComment(""),O=t=>null===t||"object"!=typeof t&&"function"!=typeof t,R=Array.isArray,P="[ \t\n\f\r]",L=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,M=/-->/g,k=/>/g,H=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),I=/'/g,D=/"/g,U=/^(?:script|style|textarea|title)$/i,B=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),W=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),G=new WeakMap,Y=S.createTreeWalker(S,129);function j(t,e){if(!R(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==C?C.createHTML(e):e}const q=(t,e)=>{const i=t.length-1,s=[];let r,n=2===e?"<svg>":3===e?"<math>":"",o=L;for(let e=0;e<i;e++){const i=t[e];let a,m,l=-1,c=0;for(;c<i.length&&(o.lastIndex=c,m=o.exec(i),null!==m);)c=o.lastIndex,o===L?"!--"===m[1]?o=M:void 0!==m[1]?o=k:void 0!==m[2]?(U.test(m[2])&&(r=RegExp("</"+m[2],"g")),o=H):void 0!==m[3]&&(o=H):o===H?">"===m[0]?(o=r??L,l=-1):void 0===m[1]?l=-2:(l=o.lastIndex-m[2].length,a=m[1],o=void 0===m[3]?H:'"'===m[3]?D:I):o===D||o===I?o=H:o===M||o===k?o=L:(o=H,r=void 0);const h=o===H&&t[e+1].startsWith("/>")?" ":"";n+=o===L?i+E:l>=0?(s.push(a),i.slice(0,l)+A+i.slice(l)+T+h):i+T+(-2===l?e:h)}return[j(t,n+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]};class V{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0;const o=t.length-1,a=this.parts,[m,l]=q(t,e);if(this.el=V.createElement(m,i),Y.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=Y.nextNode())&&a.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(const t of s.getAttributeNames())if(t.endsWith(A)){const e=l[n++],i=s.getAttribute(t).split(T),o=/([.?@])?(.*)/.exec(e);a.push({type:1,index:r,name:o[2],strings:i,ctor:"."===o[1]?Q:"?"===o[1]?tt:"@"===o[1]?et:Z}),s.removeAttribute(t)}else t.startsWith(T)&&(a.push({type:6,index:r}),s.removeAttribute(t));if(U.test(s.tagName)){const t=s.textContent.split(T),e=t.length-1;if(e>0){s.textContent=v?v.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],F()),Y.nextNode(),a.push({type:2,index:++r});s.append(t[e],F())}}}else if(8===s.nodeType)if(s.data===N)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(T,t+1));)a.push({type:7,index:r}),t+=T.length-1}r++}}static createElement(t,e){const i=S.createElement("template");return i.innerHTML=t,i}}function J(t,e,i=t,s){if(e===W)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl;const n=O(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t),r._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=J(t,r._$AS(t,e.values),r,s)),e}class K{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??S).importNode(e,!0);Y.currentNode=s;let r=Y.nextNode(),n=0,o=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new X(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new it(r,this,t)),this._$AV.push(e),a=i[++o]}n!==a?.index&&(r=Y.nextNode(),n++)}return Y.currentNode=S,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=J(this,t,e),O(t)?t===z||null==t||""===t?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==W&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>R(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==z&&O(this._$AH)?this._$AA.nextSibling.data=t:this.T(S.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=V.createElement(j(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new K(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=G.get(t.strings);return void 0===e&&G.set(t.strings,e=new V(t)),e}k(t){R(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const r of t)s===e.length?e.push(i=new X(this.O(F()),this.O(F()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class Z{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=z}_$AI(t,e=this,i,s){const r=this.strings;let n=!1;if(void 0===r)t=J(this,t,e,0),n=!O(t)||t!==this._$AH&&t!==W,n&&(this._$AH=t);else{const s=t;let o,a;for(t=r[0],o=0;o<r.length-1;o++)a=J(this,s[i+o],e,o),a===W&&(a=this._$AH[o]),n||=!O(a)||a!==this._$AH[o],a===z?t=z:t!==z&&(t+=(a??"")+r[o+1]),this._$AH[o]=a}n&&!s&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Q extends Z{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}}class tt extends Z{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==z)}}class et extends Z{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=J(this,t,e,0)??z)===W)return;const i=this._$AH,s=t===z&&i!==z||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==z&&(i===z||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class it{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){J(this,t)}}const st=w.litHtmlPolyfillSupport;st?.(V,X),(w.litHtmlVersions??=[]).push("3.3.1");const rt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class nt extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new X(e.insertBefore(F(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}nt._$litElement$=!0,nt.finalized=!0,rt.litElementHydrateSupport?.({LitElement:nt});const ot=rt.litElementPolyfillSupport;ot?.({LitElement:nt}),(rt.litElementVersions??=[]).push("4.2.1");const at=(t,e,i,s)=>{const r=new Event(e,{bubbles:s?.bubbles??!0,cancelable:s?.cancelable??!1,composed:s?.composed??!0});return r.detail=i,t.dispatchEvent(r),r};class mt extends nt{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0,this._ro=null,this._hass=void 0}static styles=n`
  ...
  `;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const t=this.renderRoot?.querySelector(".ratio")||this;if(!t)return;this._ro=new ResizeObserver(e=>{for(const i of e){const e=(i.contentBoxSize?.[0]?.inlineSize??i.contentRect?.width??t.clientWidth??300)/300;this.style.setProperty("--sac-scale",String(e))}}),this._ro.observe(t)})}disconnectedCallback(){try{this._ro?.disconnect()}catch(t){}this._ro=null,super.disconnectedCallback()}setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');const e=t=>null==t||""===t?NaN:Number(t),i=Number.isFinite(e(t.ring_pct))?e(t.ring_pct):45,s=Number.isFinite(e(t.inner_pct))?e(t.inner_pct):46.5,r=Number.isFinite(e(t.y_offset_pct))?e(t.y_offset_pct):0;this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,decimals:Number.isFinite(e(t.decimals))?e(t.decimals):1,default_wind_speed:Number.isFinite(e(t.default_wind_speed))?e(t.default_wind_speed):0,t_frosty_min:Number.isFinite(e(t.t_frosty_min))?e(t.t_frosty_min):-40,t_frosty_max:Number.isFinite(e(t.t_frosty_max))?e(t.t_frosty_max):2.9,t_cold_min:Number.isFinite(e(t.t_cold_min))?e(t.t_cold_min):3,t_cold_max:Number.isFinite(e(t.t_cold_max))?e(t.t_cold_max):4.9,t_chilly_min:Number.isFinite(e(t.t_chilly_min))?e(t.t_chilly_min):5,t_chilly_max:Number.isFinite(e(t.t_chilly_max))?e(t.t_chilly_max):8.9,t_cool_min:Number.isFinite(e(t.t_cool_min))?e(t.t_cool_min):9,t_cool_max:Number.isFinite(e(t.t_cool_max))?e(t.t_cool_max):13.9,t_mild_min:Number.isFinite(e(t.t_mild_min))?e(t.t_mild_min):14,t_mild_max:Number.isFinite(e(t.t_mild_max))?e(t.t_mild_max):18.9,t_perf_min:Number.isFinite(e(t.t_perf_min))?e(t.t_perf_min):19,t_perf_max:Number.isFinite(e(t.t_perf_max))?e(t.t_perf_max):23.9,t_warm_min:Number.isFinite(e(t.t_warm_min))?e(t.t_warm_min):24,t_warm_max:Number.isFinite(e(t.t_warm_max))?e(t.t_warm_max):27.9,t_hot_min:Number.isFinite(e(t.t_hot_min))?e(t.t_hot_min):28,t_hot_max:Number.isFinite(e(t.t_hot_max))?e(t.t_hot_max):34.9,t_boiling_min:Number.isFinite(e(t.t_boiling_min))?e(t.t_boiling_min):35,t_boiling_max:Number.isFinite(e(t.t_boiling_max))?e(t.t_boiling_max):60,ring_pct:i,inner_pct:s,center_pct:50,y_offset_pct:r,rh_left_inner_pct:Number.isFinite(e(t.rh_left_inner_pct))?e(t.rh_left_inner_pct):40,rh_right_inner_pct:Number.isFinite(e(t.rh_right_inner_pct))?e(t.rh_right_inner_pct):60}}render(){if(!this.hass||!this._config)return B``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e){this.style.setProperty("--sac-temp-bg","#2a2a2a");const{y_center:t}=this.#t();return B`
      ...
      `}const s=(t.attributes.unit_of_measurement||"°C").trim(),r=this.#n(Number.isFinite(+t.state)?+t.state:NaN,s),n=this.#o(Number.isFinite(+e.state)?+e.state:NaN),o=this.#a(i,this._config.default_wind_speed),a=n/100*this.#m(r),m=this.#l(a),l=this.#c(r,a,o),c=this.#h(m),h=this.#_(r),_=this.#d(n),d=this.#p(r),p=this.#i(c),u=this.#r(),f=this.#s(n,r,u),g=Number(this._config?.rh_left_inner_pct??40),x=Number(this._config?.rh_right_inner_pct??60),b=this.#u(),y=Number.isFinite(r)&&r>u.PERFECT.max,$=Number.isFinite(r)&&r<u.PERFECT.min,w=Number.isFinite(n)&&n<g,v=Number.isFinite(n)&&n>x,C=y?`color:white; text-shadow:\n      0 0 2px white, 0 0 6px ${b.hot}, 0 0 12px ${b.hot}, 0 0 20px ${b.hot}`:"",A=$?`color:white; text-shadow:\n      0 0 2px white, 0 0 6px ${b.cold}, 0 0 12px ${b.cold}, 0 0 20px ${b.cold}`:"",T=w?`color:white; text-shadow:\n      0 0 2px white, 0 0 6px ${b.humid}, 0 0 12px ${b.humid}, 0 0 20px ${b.humid}`:"",N=v?`color:white; text-shadow:\n      0 0 2px white, 0 0 6px ${b.humid}, 0 0 12px ${b.humid}, 0 0 20px ${b.humid}`:"",E=this.#f(r),S=Number.isFinite(E)?this.#g(E+(this._config.y_offset_pct||0),0,100):50,F=this.#x(n),O=Number.isFinite(F)?this.#g(F,0,100):50,R=!Number.isFinite(n)||!Number.isFinite(r)||(n<g||n>x||r<u.PERFECT.min||r>u.PERFECT.max),P=this._config.decimals,L=s,M=this.#b(this.#y(m,L),P)+` ${L}`,k=this.#b(this.#y(l,L),P)+` ${L}`,H=this.#b(this.#y(r,L),P)+` ${L}`,I=Number.isFinite(n)?this.#$(n,P).toFixed(P)+" %":"—";return this.style.setProperty("--sac-temp-bg",d),B`
      <div class="ratio" role="img" aria-label="Air comfort dial">
        <div class="canvas">
          ${this.#e({Tc:r,RH:n,dpC:m,atC:l,dewText:c,tempText:h,rhText:_,cardBg:d,ringGrad:p,innerGrad:f,xPct:O,yPct:S,outside:R,outUnit:L,d:P,dewOut:M,atOut:k,tempRaw:H,rhRaw:I,axisTopStyle:C,axisBottomStyle:A,axisLeftStyle:T,axisRightStyle:N})}
        </div>
      </div>
    `}#e({dewText:t,tempText:e,rhText:i,ringGrad:s,innerGrad:r,xPct:n,yPct:o,outside:a,dewOut:m,atOut:l,tempRaw:c,rhRaw:h,axisTopStyle:_="",axisBottomStyle:d="",axisLeftStyle:p="",axisRightStyle:u=""}){return B`
      <div class="header">
  ...
  `;connectedCallback(){super.connectedCallback(),window.loadCardHelpers?.().catch(()=>{})}set hass(t){this._hass=t,this._autoFillDefaults(),this.requestUpdate()}get hass(){return this._hass}setConfig(t){this._config={name:"Area Name",temperature:void 0,humidity:void 0,windspeed:void 0,decimals:1,default_wind_speed:.1,t_frosty_min:-40,t_frosty_max:2.9,t_cold_min:3,t_cold_max:4.9,t_chilly_min:5,t_chilly_max:8.9,t_cool_min:9,t_cool_max:13.9,t_mild_min:14,t_mild_max:18.9,t_perf_min:19,t_perf_max:23.9,t_warm_min:24,t_warm_max:27.9,t_hot_min:28,t_hot_max:34.9,t_boiling_min:35,t_boiling_max:60,y_offset_pct:0,rh_left_inner_pct:40,rh_right_inner_pct:60,...t??{}},this._schemaTempsTop=[{name:"t_boiling_max",selector:{number:{min:-60,max:80,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"t_hot_max",selector:{number:{min:-60,max:60,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"t_warm_max",selector:{number:{min:-60,max:50,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"t_perf_max",selector:{number:{min:-60,max:45,step:.1,mode:"box",unit_of_measurement:"°C"}}}],this._schemaTempsBottom=[{name:"t_perf_min",selector:{number:{min:-60,max:45,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"t_mild_min",selector:{number:{min:-60,max:40,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"t_cool_min",selector:{number:{min:-60,max:35,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"t_chilly_min",selector:{number:{min:-60,max:30,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"t_cold_min",selector:{number:{min:-60,max:25,step:.1,mode:"box",unit_of_measurement:"°C"}}},{name:"t_frosty_min",selector:{number:{min:-60,max:20,step:.1,mode:"box",unit_of_measurement:"°C"}}}],this._schemaMisc=[{name:"name",selector:{text:{}}},{name:"temperature",required:!0,selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity",required:!0,selector:{entity:{domain:"sensor",device_class:"humidity"}}},{name:"windspeed",selector:{entity:{domain:"sensor",device_class:"wind_speed"}}},{name:"default_wind_speed",selector:{number:{min:0,max:50,step:.1,mode:"box",unit_of_measurement:"m/s"}}},{name:"decimals",selector:{number:{min:0,max:3,step:1,mode:"box"}}},{name:"rh_left_inner_pct",selector:{number:{min:0,max:100,step:.1,mode:"box",unit_of_measurement:"%"}}},{name:"rh_right_inner_pct",selector:{number:{min:0,max:100,step:.1,mode:"box",unit_of_measurement:"%"}}},{name:"y_offset_pct",selector:{number:{min:-30,max:30,step:.5,mode:"box",unit_of_measurement:"%"}}}]}render(){return this.hass&&this._config?B`<div class="wrap">
    ...
    </div>`:B``}_label=t=>{const e=t.name;return{name:"Name",temperature:"Temperature entity",humidity:"Humidity entity",windspeed:"Wind speed entity (optional)",default_wind_speed:"Default wind speed (m/s)",decimals:"Decimals",rh_left_inner_pct:"Inner circle left RH (%)",rh_right_inner_pct:"Inner circle right RH (%)",ring_pct:"Outer ring box size (% of card)",inner_pct:"Inner circle size (% of ring box)",y_offset_pct:"Vertical dot offset (%)"}[e]??e};_labelTemp=t=>({t_boiling_max:"BOILING max → top (100%)",t_hot_max:"HOT max (even WARM.max→BOILING.max)",t_warm_max:"WARM max → outer-top",t_perf_max:"PERFECT max → inner-top",t_perf_min:"PERFECT min → inner-bottom",t_mild_min:"MILD min → outer-bottom",t_cool_min:"COOL min (even FROSTY.min→MILD.min)",t_chilly_min:"CHILLY min (even FROSTY.min→MILD.min)",t_cold_min:"COLD min (even FROSTY.min→MILD.min)",t_frosty_min:"FROSTY min → bottom (0%)"}[t.name]??t.name);_helper=t=>{const e=t.name,i=t=>this.hass?.states?.[this._config?.[t]],s=t=>i(t)?.attributes?.unit_of_measurement??"",r={t_cold_min:"t_frosty_max",t_chilly_min:"t_cold_max",t_cool_min:"t_chilly_max",t_mild_min:"t_cool_max",t_perf_min:"t_mild_max",t_warm_min:"t_perf_max",t_hot_min:"t_warm_max"};switch(e){case"name":return"Shown as the small grey title at the top of the card.";case"temperature":return"Pick an indoor temperature sensor. "+(s("temperature")?`Current unit: ${s("temperature")}.`:"");case"humidity":return"Pick a relative humidity sensor (0–100%). "+(s("humidity")?`Current unit: ${s("humidity")}.`:"");case"windspeed":return"Optional. If set, Apparent Temperature uses this wind; if empty, the “Default wind speed” below is used.";case"default_wind_speed":return"Indoor fallback for Apparent Temperature when no wind sensor is set. Typical indoors: 0.0–0.2 m/s.";case"decimals":return"How many decimal places to show for temperatures and humidity.";case"rh_left_inner_pct":case"rh_right_inner_pct":return"Maps RH to the inner-circle intersections horizontally: left = this %, right = this %. 0% stays at the left edge; 100% stays at the right edge.";case"y_offset_pct":return"Fine-tune the dot’s vertical position in % of card height (positive moves up)."}if("t_frosty_min"===e)return"Unused lower edge (ignored on save).";if("t_boiling_max"===e)return"Unused upper edge (ignored on save).";if(e in r){const t=r[e];return this._config,this._config,`Locked = ${(t=>(t?.match(/^t_(.+)_(min|max)$/)?.[1]||"").toUpperCase())(t)} max +0.1 °C`}return["t_boiling_max","t_hot_max","t_warm_max","t_perf_max"].includes(e)?"This *.max will pull the next *.min as needed to keep 0.1 °C gaps.":["t_perf_min","t_mild_min","t_cool_min","t_chilly_min","t_cold_min","t_frosty_min"].includes(e)?"This *.min will push the previous *.max as needed to keep 0.1 °C gaps.":/^t_.*_(min|max)$/.test(e)?"Bands use 0.1 °C steps. Each next min follows the previous max + 0.1.":"Tip: values update immediately; click Save when done."};_centerTemp(){const t=this._config||{},e=Number(t.t_perf_min),i=Number(t.t_perf_max);return Number.isFinite(e)&&Number.isFinite(i)?`${((e+i)/2).toFixed(2)} °C`:"—"}_onMiscChange=t=>{t.stopPropagation();const e={...t.detail?.value||{}};if(!Object.keys(e).length)return;const i={...this._config||{},...e};this._config=i,at(this,"config-changed",{config:i})};_onTempsChange=t=>{t.stopPropagation();const e={...t.detail?.value||{}};if(!Object.keys(e).length)return;const i=this._applyTempsRowBiDirectional({...this._config||{},...e});this._config=i,at(this,"config-changed",{config:i})};_applyTempsRowBiDirectional(t){const e=t=>Math.round(10*(Number(t)??0))/10,i=.1,s={boiling_max:e(t.t_boiling_max??60),hot_max:e(t.t_hot_max??34.9),warm_max:e(t.t_warm_max??27.9),perf_max:e(t.t_perf_max??23.9),perf_min:e(t.t_perf_min??19),mild_min:e(t.t_mild_min??14),cool_min:e(t.t_cool_min??9),chilly_min:e(t.t_chilly_min??5),cold_min:e(t.t_cold_min??3),frosty_min:e(t.t_frosty_min??-40)},r=["boiling_max","hot_max","warm_max","perf_max","perf_min","mild_min","cool_min","chilly_min","cold_min","frosty_min"];for(let t=1;t<r.length;t++){const n=r[t],o=e(s[r[t-1]]-i);s[n]>o&&(s[n]=o)}for(let t=r.length-2;t>=0;t--){const n=r[t],o=e(s[r[t+1]]+i);s[n]<o&&(s[n]=o)}const n={...t};n.t_boiling_max=s.boiling_max,n.t_hot_max=s.hot_max,n.t_warm_max=s.warm_max,n.t_perf_max=s.perf_max,n.t_perf_min=s.perf_min,n.t_mild_min=s.mild_min,n.t_cool_min=s.cool_min,n.t_chilly_min=s.chilly_min,n.t_cold_min=s.cold_min,n.t_frosty_min=s.frosty_min,n.t_frosty_max=e(s.cold_min-i),n.t_cold_max=e(s.chilly_min-i),n.t_chilly_max=e(s.cool_min-i),n.t_cool_max=e(s.mild_min-i),n.t_mild_max=e(s.perf_min-i),n.t_warm_min=e(s.perf_max+i),n.t_hot_min=e(s.warm_max+i),n.t_boiling_min=e(s.hot_max+i);const o=t=>Math.min(100,Math.max(0,e(t)));return n.rh_left_inner_pct=o(n.rh_left_inner_pct??40),n.rh_right_inner_pct=o(n.rh_right_inner_pct??60),n.rh_right_inner_pct<=n.rh_left_inner_pct&&(n.rh_right_inner_pct=o(n.rh_left_inner_pct+.1)),n}_autoPicked=!1;_autoFillDefaults(){if(this._autoPicked||!this.hass||!this._config)return;const t=this.hass.states,e=e=>{for(const[i,s]of Object.entries(t))if(e(i,s))return i},i=t=>t?.attributes?.device_class;this._config.temperature||(this._config.temperature=e((t,e)=>t.startsWith("sensor.")&&"temperature"===i(e))||this._config.temperature),this._config.humidity||(this._config.humidity=e((t,e)=>t.startsWith("sensor.")&&"humidity"===i(e))||this._config.humidity),this._autoPicked=!0,at(this,"config-changed",{config:this._config})}}customElements.get("simple-air-comfort-card-editor")||customElements.define("simple-air-comfort-card-editor",lt);window.customCards=window.customCards||[],window.customCards.push({type:"simple-air-comfort-card",name:"Simple Air Comfort Card",description:"Dew point + AT dial, comfort words, moving dot.",preview:!0,documentationURL:"https://github.com/MankiniChykan/simple-air-comfort-card"}),console.info('%c SIMPLE AIR COMFORT CARD %c v"1.0.280" ',"color:white;background:#2a2a2a;padding:2px 6px;border-radius:4px 0 0 4px;","color:#2a2a2a;background:#c9c9c9;padding:2px 6px;border-radius:0 4px 4px 0;"),mt.prototype.getCardSize=function(){return 3},mt.prototype.getGridOptions=function(){return{columns:6,rows:"auto",min_columns:6,max_columns:12,min_rows:1,max_rows:6}};

 ...
 */class st extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let n=r._$litPart$;if(void 0===n){const t=i?.renderBefore??null;r._$litPart$=n=new X(e.insertBefore(F(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}st._$litElement$=!0,st.finalized=!0,nt.litElementHydrateSupport?.({LitElement:st});const at=nt.litElementPolyfillSupport;at?.({LitElement:st}),(nt.litElementVersions??=[]).push("4.2.1");const ot=(t,e,i,r)=>{const n=new Event(e,{bubbles:r?.bubbles??!0,cancelable:r?.cancelable??!1,composed:r?.composed??!0});return n.detail=i,t.dispatchEvent(n),n};class lt extends st{static properties={hass:{type:Object},_config:{state:!0}};constructor(){super(),this._config=void 0,this._ro=null,this._hass=void 0}static styles=s`
  ...
  `;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const t=this.renderRoot?.querySelector(".ratio")||this;if(!t)return;this._ro=new ResizeObserver(e=>{for(const i of e){const e=(i.contentBoxSize?.[0]?.inlineSize??i.contentRect?.width??t.clientWidth??300)/300;this.style.setProperty("--sac-scale",String(e))}}),this._ro.observe(t)})}disconnectedCallback(){try{this._ro?.disconnect()}catch(t){}this._ro=null,super.disconnectedCallback()}setConfig(t){if(!t||!t.temperature||!t.humidity)throw new Error('simple-air-comfort-card: "temperature" and "humidity" are required.');const e=t=>null==t||""===t?NaN:Number(t),i=Number.isFinite(e(t.ring_pct))?e(t.ring_pct):45,r=Number.isFinite(e(t.inner_pct))?e(t.inner_pct):46.5,n=Number.isFinite(e(t.y_offset_pct))?e(t.y_offset_pct):0;this._config={name:t.name??"Air Comfort",temperature:t.temperature,humidity:t.humidity,windspeed:t.windspeed,feels_like:t.feels_like??"bom",decimals:Number.isFinite(e(t.decimals))?e(t.decimals):1,default_wind_speed:Number.isFinite(e(t.default_wind_speed))?e(t.default_wind_speed):0,t_frosty_min:Number.isFinite(e(t.t_frosty_min))?e(t.t_frosty_min):-40,t_frosty_max:Number.isFinite(e(t.t_frosty_max))?e(t.t_frosty_max):2.9,t_cold_min:Number.isFinite(e(t.t_cold_min))?e(t.t_cold_min):3,t_cold_max:Number.isFinite(e(t.t_cold_max))?e(t.t_cold_max):4.9,t_chilly_min:Number.isFinite(e(t.t_chilly_min))?e(t.t_chilly_min):5,t_chilly_max:Number.isFinite(e(t.t_chilly_max))?e(t.t_chilly_max):8.9,t_cool_min:Number.isFinite(e(t.t_cool_min))?e(t.t_cool_min):9,t_cool_max:Number.isFinite(e(t.t_cool_max))?e(t.t_cool_max):13.9,t_mild_min:Number.isFinite(e(t.t_mild_min))?e(t.t_mild_min):14,t_mild_max:Number.isFinite(e(t.t_mild_max))?e(t.t_mild_max):18.9,t_perf_min:Number.isFinite(e(t.t_perf_min))?e(t.t_perf_min):19,t_perf_max:Number.isFinite(e(t.t_perf_max))?e(t.t_perf_max):23.9,t_warm_min:Number.isFinite(e(t.t_warm_min))?e(t.t_warm_min):24,t_warm_max:Number.isFinite(e(t.t_warm_max))?e(t.t_warm_max):27.9,t_hot_min:Number.isFinite(e(t.t_hot_min))?e(t.t_hot_min):28,t_hot_max:Number.isFinite(e(t.t_hot_max))?e(t.t_hot_max):34.9,t_boiling_min:Number.isFinite(e(t.t_boiling_min))?e(t.t_boiling_min):35,t_boiling_max:Number.isFinite(e(t.t_boiling_max))?e(t.t_boiling_max):60,ring_pct:i,inner_pct:r,center_pct:50,y_offset_pct:n,rh_left_inner_pct:Number.isFinite(e(t.rh_left_inner_pct))?e(t.rh_left_inner_pct):40,rh_right_inner_pct:Number.isFinite(e(t.rh_right_inner_pct))?e(t.rh_right_inner_pct):60}}render(){if(!this.hass||!this._config)return U``;const t=this.hass.states[this._config.temperature],e=this.hass.states[this._config.humidity],i=this._config.windspeed?this.hass.states[this._config.windspeed]:void 0;if(!t||!e){this.style.setProperty("--sac-temp-bg","#2a2a2a");const{y_center:t}=this.#t();return U`
        <div class="ratio" role="img" aria-label="Air comfort dial">
          <div class="canvas">
            ${this.#e({dewText:"Unknown",tempText:"N/A",rhText:"N/A",ringGrad:this.#i("Unknown"),innerGrad:this.#r(NaN,NaN,this.#n()),xPct:50,yPct:t,outside:!0,dewOut:"—",atOut:"—",tempRaw:"—",rhRaw:"—",axisTopStyle:"",axisBottomStyle:"",axisLeftStyle:"",axisRightStyle:""})}
          </div>
        </div>
      `}const r=(t.attributes.unit_of_measurement||"°C").trim(),n=this.#s(Number.isFinite(+t.state)?+t.state:NaN,r),s=this.#a(Number.isFinite(+e.state)?+e.state:NaN),a=this.#o(i,this._config.default_wind_speed),o=s/100*this.#l(n),l=this.#m(o);let m,c;switch(String(this._config.feels_like||"bom")){case"wind_chill":m=this.#c(n,a),c="Wind Chill";break;case"heat_index":m=this.#h(n,s),c="Heat Index";break;case"humidex":m=this.#d(n,o),c="Humidex";break;default:m=this.#_(n,o,a),c="BoM AT"}const h=this.#p(l),d=this.#u(n),_=this.#f(s),p=this.#g(n),u=this.#i(h),f=this.#n(),g=this.#r(s,n,f),b=Number(this._config?.rh_left_inner_pct??40),x=Number(this._config?.rh_right_inner_pct??60),y=this.#b(),w=Number.isFinite(n)&&n>f.PERFECT.max,$=Number.isFinite(n)&&n<f.PERFECT.min,v=Number.isFinite(s)&&s<b,C=Number.isFinite(s)&&s>x,A=w?`color:white; text-shadow:\n      0 0 2px white, 0 0 6px ${y.hot}, 0 0 12px ${y.hot}, 0 0 20px ${y.hot}`:"",T=$?`color:white; text-shadow:\n      0 0 2px white, 0 0 6px ${y.cold}, 0 0 12px ${y.cold}, 0 0 20px ${y.cold}`:"",N=v?`color:white; text-shadow:\n      0 0 2px white, 0 0 6px ${y.humid}, 0 0 12px ${y.humid}, 0 0 20px ${y.humid}`:"",E=C?`color:white; text-shadow:\n      0 0 2px white, 0 0 6px ${y.humid}, 0 0 12px ${y.humid}, 0 0 20px ${y.humid}`:"",O=this.#x(n),F=Number.isFinite(O)?this.#y(O+(this._config.y_offset_pct||0),0,100):50,R=this.#w(s),L=Number.isFinite(R)?this.#y(R,0,100):50,S=!Number.isFinite(s)||!Number.isFinite(n)||(s<b||s>x||n<f.PERFECT.min||n>f.PERFECT.max),M=this._config.decimals,k=r,P=this.#$(this.#v(l,k),M)+` ${k}`,H=this.#$(this.#v(m,k),M)+` ${k}`,I=this.#$(this.#v(n,k),M)+` ${k}`,D=Number.isFinite(s)?this.#C(s,M).toFixed(M)+" %":"—";return this.style.setProperty("--sac-temp-bg",p),U`
      <div class="ratio" role="img" aria-label="Air comfort dial">
        <div class="canvas">
          ${this.#e({Tc:n,RH:s,dpC:l,atC:m,dewText:h,tempText:d,rhText:_,cardBg:p,ringGrad:u,innerGrad:g,xPct:L,yPct:F,outside:S,outUnit:k,d:M,dewOut:P,atOut:H,tempRaw:I,rhRaw:D,atTag:c,axisTopStyle:A,axisBottomStyle:T,axisLeftStyle:N,axisRightStyle:E})}
        </div>
      </div>
    `}#e({dewText:t,tempText:e,rhText:i,ringGrad:r,innerGrad:n,xPct:s,yPct:a,outside:o,dewOut:l,atOut:m,tempRaw:c,rhRaw:h,atTag:d,axisTopStyle:_="",axisBottomStyle:p="",axisLeftStyle:u="",axisRightStyle:f=""}){return U`
      <div class="header">
    ...
    `}#_(t,e,i){return t+.33*e-.7*i-4}#c(t,e){if(!Number.isFinite(t)||!Number.isFinite(e))return NaN;const i=3.6*e;return 13.12+.6215*t-11.37*Math.pow(i,.16)+.3965*t*Math.pow(i,.16)}#h(t,e){if(!Number.isFinite(t)||!Number.isFinite(e))return NaN;const i=9*t/5+32,r=this.#a(e);return 5*(2.04901523*i-42.379+10.14333127*r+-.22475541*i*r+-.00683783*i*i+-.05481717*r*r+.00122874*i*i*r+85282e-8*i*r*r+-199e-8*i*i*r*r-32)/9}#d(t,e){return Number.isFinite(t)&&Number.isFinite(e)?t+.5555*(e-10):NaN}#l(t){return Number.isFinite(t)?t>=0?6.1121*Math.exp(t/(257.14+t)*(18.678-t/234.5)):6.1115*Math.exp(t/(279.82+t)*(23.036-t/333.7)):NaN}#m(t){if(!Number.isFinite(t)||t<=0)return NaN;let e=-80,i=60,r=0;for(let n=0;n<60;n++){r=(e+i)/2;const n=this.#l(r);if(!Number.isFinite(n))break;if(n>t?i=r:e=r,Math.abs(i-e)<1e-4)break}return r}#p(t){return Number.isFinite(t)?t<5?"Very Dry":t<=10?"Dry":t<=12.79?"Pleasant":t<=15.49?"Comfortable":t<=18.39?"Sticky Humid":t<=21.19?"Muggy":t<=23.9?"Sweltering":"Stifling":"Unknown"}#u(t){if(!Number.isFinite(t))return"N/A";const e=this.#n(),i=this.#A(t),r=[["FROSTY",e.FROSTY.min,e.FROSTY.max],["COLD",e.COLD.min,e.COLD.max],["CHILLY",e.CHILLY.min,e.CHILLY.max],["COOL",e.COOL.min,e.COOL.max],["MILD",e.MILD.min,e.MILD.max],["PERFECT",e.PERFECT.min,e.PERFECT.max],["WARM",e.WARM.min,e.WARM.max],["HOT",e.HOT.min,e.HOT.max],["BOILING",e.BOILING.min,e.BOILING.max]];for(const[t,e,n]of r)if(i>=e&&i<=n)return t;return i<r[0][1]?"FROSTY":"BOILING"}#f(t){if(!Number.isFinite(t))return"N/A";const e=Number(this._config?.rh_left_inner_pct??40),i=Number(this._config?.rh_right_inner_pct??60);return t<e?"DRY":t<=i?"COMFY":"HUMID"}#T(t){return Number.isFinite(t)?this.#u(t).toLowerCase():"n/a"}#N(t){const e=String(t||"").toLowerCase();return"frosty"===e?"mediumblue":"cold"===e?"dodgerblue":"chilly"===e?"deepskyblue":"cool"===e?"mediumaquamarine":"mild"===e?"seagreen":"perfect"===e?"limegreen":"warm"===e?"gold":"hot"===e?"orange":"boiling"===e?"crimson":"dimgray"}#g(t){const e=this.#T(t);return`radial-gradient(circle, rgba(100,100,100,0.15), rgba(100,100,100,0.15), rgba(100,100,100,0.15), ${this.#N(e)})`}#i(t){return`radial-gradient(circle, ${{"Very Dry":"deepskyblue",Dry:"mediumaquamarine",Pleasant:"limegreen",Comfortable:"yellowgreen","Sticky Humid":"yellow",Muggy:"gold",Sweltering:"orange",Stifling:"crimson"}[t]||"dimgray"}, 55%, rgba(100,100,100,0.15), rgba(100,100,100,0.15))`}#r(t,e,i){const r=this.#b(),n=Number(this._config?.rh_left_inner_pct??40),s=Number(this._config?.rh_right_inner_pct??60);let a="black";Number.isFinite(t)?(t<n||t>s)&&(a=r.humid):a="dimgray";const o=i.PERFECT.min,l=i.PERFECT.max;let m=r.inband;return Number.isFinite(e)&&(e>l?m=r.hot:e<o&&(m=r.cold)),`radial-gradient(circle, ${a} 0%, black, ${m} 70%)`}#y(t,e,i){return Math.min(i,Math.max(e,t))}#E(t,e,i){return e+(i-e)*t}#O(t,e,i){return(t-e)/(i-e)}#A(t){return Math.round(10*t)/10}#F(t){return t*t*(3-2*t)}#b(){return{hot:"var(--sac-col-hot, rgba(255,69,0,0.95))",cold:"var(--sac-col-cold, rgba(0,102,255,0.95))",humid:"var(--sac-col-humid-alert, hotpink)",inband:"var(--sac-col-inband, dimgray)"}}#n(){const t=this._config||{},e=(t,e)=>{const i=Number.isFinite(t)?t:e;return Math.round(10*i)/10},i={FROSTY:{min:e(t.t_frosty_min,-40),max:e(t.t_frosty_max,2.9)},COLD:{min:e(t.t_cold_min,3),max:e(t.t_cold_max,4.9)},CHILLY:{min:e(t.t_chilly_min,5),max:e(t.t_chilly_max,8.9)},COOL:{min:e(t.t_cool_min,9),max:e(t.t_cool_max,13.9)},MILD:{min:e(t.t_mild_min,14),max:e(t.t_mild_max,18.9)},PERFECT:{min:e(t.t_perf_min,19),max:e(t.t_perf_max,23.9)},WARM:{min:e(t.t_warm_min,24),max:e(t.t_warm_max,27.9)},HOT:{min:e(t.t_hot_min,28),max:e(t.t_hot_max,34.9)},BOILING:{min:e(t.t_boiling_min,35),max:e(t.t_boiling_max,60)}},r=["FROSTY","COLD","CHILLY","COOL","MILD","PERFECT","WARM","HOT","BOILING"];for(let t=0;t<r.length;t++){const n=r[t-1]&&i[r[t-1]],s=i[r[t]];if(t>0){const t=e(n.max+.1,n.max+.1);s.min<t&&(s.min=t)}s.max<s.min&&(s.max=s.min)}return i}#t(){const t=Number(this._config?.ring_pct??45),e=Number(this._config?.inner_pct??46.5),i=Number(this._config?.center_pct??50),r=t/2,n=e/100*(t/2),s=i-r,a=i+r;return{y_outer_bottom:s,y_outer_top:a,y_inner_bottom:i-n,y_inner_top:i+n,y_center:i,y_half_below_outer:(0+s)/2,y_half_above_outer:(100+a)/2,x_inner_left:50-n,x_inner_right:50+n}}#w(t){if(!Number.isFinite(t))return NaN;const{x_inner_left:e,x_inner_right:i}=this.#t(),r=Number(this._config?.rh_left_inner_pct??40),n=Number(this._config?.rh_right_inner_pct??60),s=this.#y(r,0,100),a=this.#y(Math.max(n,s+.1),0,100),o=this.#y(t,0,100),l=1e-6;if(s<=l&&o<=s)return 0;if(a>=100-l&&o>=a)return 100;if(o<=s){const t=this.#O(o,0,s);return this.#E(t,0,e)}if(o>=a){const t=this.#O(o,a,100);return this.#E(t,i,100)}{const t=this.#O(o,s,a);return this.#E(t,e,i)}}#x(t){const e=this.#t(),i=this.#n(),r=e.y_outer_bottom,n=e.y_inner_bottom,s=e.y_inner_top,a=e.y_outer_top,o=(t,e,i)=>{const r=i-e;return!Number.isFinite(r)||Math.abs(r)<1e-6?0:this.#y((t-e)/r,0,1)},l=i.FROSTY.min,m=i.MILD.min,c=r,h=t=>0+o(t,l,m)*(c-0),d=h(i.FROSTY.min),_=h(i.COLD.min),p=h(i.CHILLY.min),u=h(i.COOL.min),f=h(i.MILD.min),g=i.WARM.max,b=i.BOILING.max,x=a,y=x+o(i.HOT.max,g,b)*(100-x),w=[{t:i.FROSTY.min,y:d},{t:i.COLD.min,y:_},{t:i.CHILLY.min,y:p},{t:i.COOL.min,y:u},{t:i.MILD.min,y:f},{t:i.PERFECT.min,y:n},{t:i.PERFECT.max,y:s},{t:i.WARM.max,y:a},{t:i.HOT.max,y:y},{t:i.BOILING.max,y:100}];if(!Number.isFinite(t))return e.y_center;if(t<=w[0].t)return w[0].y;if(t>=w[w.length-1].t)return w[w.length-1].y;for(let e=0;e<w.length-1;e++){const r=w[e],n=w[e+1];if(t>=r.t&&t<=n.t){const e=this.#y((t-r.t)/(n.t-r.t),0,1),s=r.t===i.MILD.min&&n.t===i.PERFECT.min||r.t===i.PERFECT.min&&n.t===i.PERFECT.max||r.t===i.PERFECT.max&&n.t===i.WARM.max?e:this.#F(e);return r.y+(n.y-r.y)*s}}return e.y_center}#a(t){return Number.isFinite(t)?Math.min(100,Math.max(0,t)):NaN}#s(t,e){return Number.isFinite(t)?(e||"").toLowerCase().includes("f")?5/9*(t-32):t:NaN}#v(t,e){return Number.isFinite(t)?(e||"").toLowerCase().includes("f")?9*t/5+32:t:NaN}#o(t,e){if(!t)return e??0;const i=parseFloat(t.state);if(!Number.isFinite(i))return e??0;const r=(t.attributes.unit_of_measurement||"m/s").toLowerCase();return r.includes("m/s")?i:r.includes("km/h")||r.includes("kph")?i/3.6:r.includes("mph")?.44704*i:r.includes("kn")?.514444*i:i}#C(t,e=1){if(!Number.isFinite(t))return NaN;const i=Math.pow(10,e);return Math.round(t*i)/i}#$(t,e=1){return Number.isFinite(t)?this.#C(t,e).toLocaleString(void 0,{minimumFractionDigits:e,maximumFractionDigits:e}):"—"}set hass(t){this._hass=t,this.requestUpdate()}get hass(){return this._hass}static getConfigElement(){return document.createElement("simple-air-comfort-card-editor")}static getStubConfig(t){const e=t??document.querySelector("home-assistant")?.hass,i=e?.states??{},r=t=>{for(const[e,r]of Object.entries(i))if(t(e,r))return e},n=t=>t?.attributes?.device_class,s=t=>(t?.attributes?.unit_of_measurement||"").toLowerCase();return{name:"Area Name",temperature:r((t,e)=>t.startsWith("sensor.")&&"temperature"===n(e))||r((t,e)=>t.startsWith("sensor.")&&/°c|°f/.test(s(e)))||r(t=>t.startsWith("sensor.")),humidity:r((t,e)=>t.startsWith("sensor.")&&"humidity"===n(e))||r((t,e)=>t.startsWith("sensor.")&&s(e).includes("%"))||r(t=>t.startsWith("sensor.")),windspeed:r((t,e)=>t.startsWith("sensor.")&&"wind_speed"===n(e))||r((t,e)=>t.startsWith("sensor.")&&/(m\/s|km\/h|kph|mph|kn)/.test(s(e))),decimals:1,default_wind_speed:.1}}}customElements.define("simple-air-comfort-card",lt);class mt extends st{static properties={hass:{type:Object},_config:{state:!0},_schema:{state:!0}};static styles=s`
